...
var ort = (() => {
      ...
      if ((t && typeof t == "object") || typeof t == "function")
        for (let o of Nu(t))
          !Lu.call(e, o) &&
            ...
            bn(e, o, {
              get: () => t[o],
              enumerable: !(r = Vu(t, o)) || r.enumerable,
            });
      return e;
    };
      ...
      (($t = new Map()),
        ...
        (hr = async (e) => {
          ...
          return [
            ...
            new Proxy(e, {
              get: (u, d) =>
                d === "executionProviders" ? a : Reflect.get(u, d),
            }),
          ];
        }));
    });
          ...
          if (n) {
            ...
            if (c != null) {
              ...
              if (
                (t !== void 0 &&
                  ...
                  ((p = t.resizedHeight), (f = t.resizedWidth)),
                t !== void 0)
              ) {
            ...
            if (c != null) {
              let p = e.height,
                f = e.width;
              return (
                c.drawImage(e, 0, 0, f, p),
                (s = c.getImageData(0, 0, f, p).data),
                (a.height = p),
                (a.width = f),
                vn(s, a)
              );
              ...
              return new Promise((l, c) => {
                ...
                ((m.crossOrigin = "Anonymous"),
                  ...
                  (m.onload = () => {
                    ((p.width = m.width),
                      (p.height = m.height),
                      f.drawImage(m, 0, 0, p.width, p.height));
        ...
        (Pr = () => {
          if (!Er) {
            ...
            let e = typeof BigInt64Array < "u" && BigInt64Array.from,
              ...
              r = typeof n < "u" && n.from;
            (e &&
              (Ke.set("int64", BigInt64Array), ut.set(BigInt64Array, "int64")),
              t &&
                (Ke.set("uint64", BigUint64Array),
                ut.set(BigUint64Array, "uint64")),
              r
                ? (Ke.set("float16", n), ut.set(n, "float16"))
                : Ke.set("float16", Uint16Array));
          }
        }));
    });
  var Or,
            ...
            if (typeof t == "string")
              if (((o = t), (u = r), t === "string")) {
                ...
                if (Array.isArray(n)) {
                  ...
                  throw new TypeError(
                    `A ${o} tensor's data must be type of ${d}`,
                  );
              }
              ...
              if (d === "string") ((o = "string"), (a = t));
                ...
                throw new TypeError(
                  `Invalid element type of data array: ${d}.`,
                );
    ...
    Rr = E(() => {
      ...
      xt = class e {
        ...
        async run(t, n, r) {
            ...
            if (Array.isArray(n)) {
              ...
              for (let d of n) {
                ...
                if (this.outputNames.indexOf(d) === -1)
                  throw new RangeError(
                    `'fetches' contains invalid output name: ${d}.`,
                  );
                o[d] = null;
              }
          ...
          for (let d in a)
            if (Object.hasOwnProperty.call(a, d)) {
              ...
              l instanceof $e
                ? (u[d] = l)
                : (u[d] = new $e(l.type, l.data, l.dims));
            }
          return (me(), u);
        }
        async release() {
        ...
        static async create(t, n, r, o) {
          ...
          if (typeof t == "string") {
            ...
            if (typeof n == "object" && n !== null) s = n;
              ...
              if (c < 0 || c >= l.byteLength)
                throw new RangeError(
                  `'byteOffset' is out of range [0, ${l.byteLength}).`,
                );
              if (((p = t.byteLength - c), typeof r == "number")) {
                ...
                if (p <= 0 || c + p > l.byteLength)
                  throw new RangeError(
                    `'byteLength' is out of range (0, ${l.byteLength - c}].`,
                  );
          ...
          let [a, u] = await hr(s),
            d = await a.createInferenceSessionHandler(i, u);
          return (me(), new e(d));
        }
        startProfiling() {
  ...
  var qr,
    ...
    jr = E(() => {
      ...
      Hu = Fr
        ? null
        : (e) => new Worker(e ?? ye, { type: "classic", name: qr });
    });
  var qu,
    Fu,
    ye,
    ...
    Tt = E(() => {
      ...
      ((qu = typeof location > "u" ? void 0 : location.origin),
        ...
        (ye = Fu()),
        (Dt = () => {
          if (ye && !ye.startsWith("blob:"))
            return ye.substring(0, ye.lastIndexOf("/") + 1);
        }),
        (Cn = (e, t) => {
          try {
            let n = t ?? ye;
    ...
    oo = E(() => {
      ...
      ((Ju = (e) => {
          ...
          (t.use_ort_model_bytes_directly ||
            ...
            e.executionProviders &&
              e.executionProviders.some(
                (n) => (typeof n == "string" ? n : n.name) === "webgpu",
              ) &&
        ...
        (Rt = (e, t, n, r) => {
          let o = be(t, r),
            i = be(n, r);
          ne()._OrtAddSessionConfigEntry(e, o, i) !== 0 &&
            Y(`Can't set a session config entry: ${t} - ${n}.`);
        }),
        (nd = async (e, t, n) => {
          for (let r of t) {
              ...
              case "webgpu":
                if (((o = "JS"), typeof r != "string")) {
                  ...
                  if (l?.preferredLayout) {
                    if (
                      l.preferredLayout !== "NCHW" &&
                      l.preferredLayout !== "NHWC"
                    )
                      throw new Error(
        ...
        (ro = async (e) => {
          ...
          try {
            ...
            let l =
              typeof o.optimizedModelFilePath == "string"
                ? be(o.optimizedModelFilePath, r)
                : 0;
            if (
              ...
              n === 0 && Y("Can't create session options."),
            ...
            if (o.freeDimensionOverrides)
              for (let [c, p] of Object.entries(o.freeDimensionOverrides)) {
                ...
                let f = be(c, r);
                t._OrtAddFreeDimensionOverride(n, f, p) !== 0 &&
                  Y(`Can't set a free dimension override: ${c} - ${p}.`);
              }
            return (
              o.extra !== void 0 &&
            ...
            throw (
              n !== 0 &&
                ...
                Y("Can't release session options."),
              r.forEach((s) => t._free(s)),
              i
            );
          }
      ...
      ((zn = class {
        ...
        (Pe = class {
          static calcShape(t, n, r = !1) {
            ...
            if (o === 0) return n;
            if (i === 0) return t;
            let s = Math.max(t.length, n.length),
              a = new Array(s);
            if (r) {
              if (o < 2 || i < 2) return;
              let u = zn.calcMatMulShape(
                [t[o - 2], t[o - 1]],
                [n[i - 2], n[i - 1]],
              );
              if (u === void 0) return;
          ...
          static isValidBroadcast(t, n) {
            ...
            if (r > o) return !1;
            for (let i = 1; i <= r; i++)
              if (t[r - i] !== 1 && t[r - i] !== n[o - i]) return !1;
            return !0;
          }
        }),
        (x = class e {
    ...
    ho = E(() => {
      ...
      ((co = new Map([
        ...
        (mo = (e, t) => {
          ...
          return t.length > 0
            ? Math.ceil((t.reduce((r, o) => r * o) * n) / 8)
            : 0;
        }),
        (Wt = class {
          constructor(t) {
          ...
          destroy() {
            (j("verbose", () => "[WebNN] TensorWrapper.destroy"),
          ...
          async read(t) {
            if (this.fallbackDataType) {
              let n = await this.mlContext.readTensor(this.mlTensor),
                r = po(new Uint8Array(n), this.dataType);
              if (t) {
                (t instanceof ArrayBuffer
                  ? new Uint8Array(t)
              ...
              return t
                ? this.mlContext.readTensor(this.mlTensor, t)
          ...
          canReuseTensor(t, n, r) {
            return (
              ...
              this.tensorShape.every((o, i) => o === r[i])
            );
          }
        ...
        (Ht = class {
          ...
          async ensureTensor(t, n, r, o) {
            let i = this.tensorManager.getMLContext(t),
              s;
            if (!i.opSupportLimits().input.dataTypes.includes(n)) {
              if (
                ((s = ad.get(n)),
                !s || !i.opSupportLimits().input.dataTypes.includes(s))
              )
                throw new Error(
                  `WebNN backend does not support data type: ${n}`,
                );
              j(
                "verbose",
                () =>
          ...
          upload(t) {
            ...
            this.activeUpload
              ? this.activeUpload.set(n)
              : (this.activeUpload = new Uint8Array(n));
          }
          async download(t) {
            if (this.activeUpload) {
              let n = this.wrapper?.isDataConverted
                ? po(this.activeUpload, this.wrapper?.type)
                : this.activeUpload;
              if (t) {
                t instanceof ArrayBuffer
                  ? new Uint8Array(t).set(n)
                  : new Uint8Array(t.buffer, t.byteOffset, t.byteLength).set(n);
                return;
        ...
        (Dn = class {
          ...
          reserveTensorId() {
            let t = lo();
            return (this.tensorTrackersById.set(t, new Ht(this)), t);
          }
          releaseTensorId(t) {
            let n = this.tensorTrackersById.get(t);
            n &&
              (this.tensorTrackersById.delete(t),
              n.tensorWrapper && this.releaseTensor(n.tensorWrapper));
          }
          ...
          registerTensor(t, n, r, o) {
            ...
            return (
              this.tensorTrackersById.set(s, new Ht(this, a)),
              this.externalTensors.add(a),
              s
            );
          }
          async getCachedTensor(t, n, r, o, i, s, a) {
            ...
            for (let [l, c] of this.freeTensors.entries())
              if (c.canReuseTensor(u, n, r)) {
                j(
                  "verbose",
                  () =>
                    `[WebNN] Reusing tensor {dataType: ${n}, ${a ? `fallbackDataType: ${a},` : ""} shape: ${r}`,
                );
            ...
            j(
              "verbose",
              () =>
                `[WebNN] MLContext.createTensor {dataType: ${n}, ${a ? `fallbackDataType: ${a},` : ""} shape: ${r}}`,
            );
          ...
          releaseTensor(t) {
            (this.externalTensors.has(t) && this.externalTensors.delete(t),
              this.freeTensors.push(t));
          }
        }),
        (fo = (...e) => new Dn(...e)));
    });
    ...
    go = E(() => {
      ...
      ((qt = new Map([
        ...
        (ud = (e, t) => {
          ...
          return (
            n.length === r.length &&
            n.every((o, i) => o === r[i] && e[o] === t[o])
          );
        }),
        (Ft = class {
          constructor(t) {
            this.tensorManager = fo(this);
          ...
          onRunStart(t) {
            (j("verbose", () => `[WebNN] onRunStart {sessionId: ${t}}`),
          ...
          onRunEnd(t) {
            ...
            if (n) {
              ...
              (this.temporarySessionTensorIds.delete(t),
          ...
          async createMLContext(t) {
            if (t instanceof GPUDevice) {
              ...
              if (r !== -1) return this.mlContextCache[r].mlContext;
              {
                ...
                return (
                  this.mlContextCache.push({ gpuDevice: t, mlContext: o }),
                  o
                );
              }
            } else if (t === void 0) {
              let r = this.mlContextCache.findIndex(
                (o) => o.options === void 0 && o.gpuDevice === void 0,
              );
              if (r !== -1) return this.mlContextCache[r].mlContext;
              {
            ...
            let n = this.mlContextCache.findIndex((r) => ud(r.options, t));
            if (n !== -1) return this.mlContextCache[n].mlContext;
            {
              let r = await navigator.ml.createContext(t);
              return (
                this.mlContextCache.push({ options: t, mlContext: r }),
                r
              );
            }
          }
          registerMLContext(t, n) {
            ...
            (r || ((r = new Set()), this.sessionIdsByMLContext.set(n, r)),
              r.add(t),
              this.temporaryGraphInputs.length > 0 &&
                (this.sessionGraphInputs.set(t, this.temporaryGraphInputs),
                (this.temporaryGraphInputs = [])),
              this.temporaryGraphOutputs.length > 0 &&
                (this.sessionGraphOutputs.set(t, this.temporaryGraphOutputs),
                (this.temporaryGraphOutputs = [])));
          }
          onReleaseSession(t) {
            (this.sessionGraphInputs.delete(t),
              this.sessionGraphOutputs.delete(t));
            let n = this.mlContextBySessionId.get(t);
            if (!n) return;
            (this.tensorManager.releaseTensorsForSession(t),
              this.mlContextBySessionId.delete(t));
            let r = this.sessionIdsByMLContext.get(n);
          ...
          async createTemporaryTensor(t, n, r) {
            j(
              "verbose",
              () =>
                `[WebNN] createTemporaryTensor {onnxDataType: ${n}, shape: ${r}}`,
            );
            let o = qt.get(n);
            if (!o) throw new Error(`Unsupported ONNX data type: ${n}`);
            let i = this.tensorManager.reserveTensorId();
            await this.tensorManager.ensureTensor(t, i, o, r, !1);
            let s = this.temporarySessionTensorIds.get(t);
            return (
              s ? s.push(i) : this.temporarySessionTensorIds.set(t, [i]),
              i
            );
          }
          uploadTensor(t, n) {
            ...
            (j(
              "verbose",
              () =>
                `[WebNN] uploadTensor {tensorId: ${t}, data: ${n.byteLength}}`,
            ),
          ...
          registerMLConstant(t, n, r, o, i, s, a = !1) {
            ...
            if (!d)
              throw new Error(
                `File with name ${u} not found in preloaded files.`,
              );
            if (n + r > d.byteLength)
              throw new Error(
            ...
            return (
              j(
                "verbose",
                () =>
                  `[WebNN] registerMLConstant {dataType: ${i.dataType}, shape: ${i.shape}}} ${a ? "(Note: it was int64 data type and registered to int32 as workaround)" : ""}`,
              ),
              o.constant(i, c)
            );
          }
          ...
          isGraphInputOutputTypeSupported(t, n, r = !0) {
            ...
            return typeof i > "u"
              ...
              : r
                ...
                : !!o?.opSupportLimits().output.dataTypes.includes(i);
          }
          flush() {}
        }));
    });
      ...
      ((yo = new Map([
        ...
        (Vn = async (e, t, n, r) => {
          ...
          try {
            ...
            (e.endComputePass(),
              s.copyBufferToBuffer(t, 0, i, 0, o),
              e.flush(),
        ...
        (Un = class {
          constructor(t) {
            ...
            for (let [n] of yo)
              (Mn.push(n),
                this.freeBuffers.set(n, []),
                this.freeUniformBuffers.set(n, []));
            this.sessionCount = 0;
          }
          upload(t, n) {
            let r = n.buffer,
          ...
          registerExternalBuffer(t, n, r) {
            ...
            return (
              this.storageCache.set(o, {
                gpuData: { id: o, type: 0, buffer: t },
                originalSize: n,
              }),
              j(
                "verbose",
          ...
          unregisterExternalBuffer(t) {
            t !== void 0 &&
              ...
              j(
                "verbose",
                () =>
                  `[WebGPU] GpuDataManager.unregisterExternalBuffer() => id=${t}`,
              ));
          }
          create(
            t,
            n = GPUBufferUsage.STORAGE |
              GPUBufferUsage.COPY_SRC |
              GPUBufferUsage.COPY_DST,
          ) {
            let r = dd(t),
              o,
              i = (n & GPUBufferUsage.STORAGE) === GPUBufferUsage.STORAGE,
              s = (n & GPUBufferUsage.UNIFORM) === GPUBufferUsage.UNIFORM;
            if (i || s) {
            ...
            return (
              this.storageCache.set(a.id, {
                gpuData: a,
                originalSize: Number(t),
              }),
              j(
                "verbose",
                () => `[WebGPU] GpuDataManager.create(size=${t}) => id=${a.id}`,
              ),
              a
            );
          }
          ...
          return (
            e.forEach((n) => {
              n.length !== 0 &&
                t.push(
                  { type: 12, data: n },
                  { type: 12, data: x.computeStrides(n) },
                );
            }),
            t
          );
  ...
  fn o2i_${e}(offset: u32) -> ${p.indices} {
    ...
    return indices;
            ...
            w = (k) => ((m.offsetToIndices = !0), s < 2 ? k : `o2i_${e}(${k})`),
            v = [];
          if (s >= 2)
            for (let k = s - 1; k >= 0; k--)
              v.push(`${B(y, k, s)} * (indices[${k}])`);
          let $ =
              s < 2
                ? ""
                : `
  fn i2o_${e}(indices: ${p.indices}) -> u32 {
    return ${v.join("+")};
            ...
            I = (...k) =>
              s === 0 ? "0u" : `${p.indices}(${k.map(f).join(",")})`,
            A = (k, L) => (s < 2 ? `${k}` : `${B(k, L, s)}`),
            z = (k, L, oe) => (s < 2 ? `${k}=${oe};` : `${B(k, L, s)}=${oe};`),
            M = {},
            R = (k, L) => {
              m.broadcastedIndicesToOffset = !0;
              let oe = `${L.name}broadcastedIndicesTo${e}Offset`;
          ...
          return {
            impl: () => {
              let k = [],
                L = !1;
              return (
                m.offsetToIndices && (k.push(_), (L = !0)),
                m.indicesToOffset && (k.push($), (L = !0)),
                m.broadcastedIndicesToOffset &&
                  (Object.values(M).forEach((oe) => k.push(oe)), (L = !0)),
                m.set && (k.push(Q), (L = !0)),
                m.setByIndices && (k.push(U), (L = !0)),
                m.get && (k.push(G), (L = !0)),
                m.getByIndices && (k.push(ee), (L = !0)),
                !i &&
                  L &&
                  k.unshift(
...
`)
        ...
        (Ln = class {
          ...
          mainStart(t = Qe) {
            ...
            if (
              ...
              o > this.limits.maxComputeWorkgroupSizeZ
            )
              throw new Error(
                `workgroup size [${n}, ${r}, ${o}] exceeds the maximum workgroup size [${this.limits.maxComputeWorkgroupSizeX}, ${this.limits.maxComputeWorkgroupSizeY}, ${this.limits.maxComputeWorkgroupSizeZ}].`,
              );
            if (n * r * o > this.limits.maxComputeInvocationsPerWorkgroup)
              throw new Error(
                `workgroup size [${n}, ${r}, ${o}] exceeds the maximum workgroup invocations ${this.limits.maxComputeInvocationsPerWorkgroup}.`,
              );
            let i =
  ...
  `;
          ...
          declareVariables(...t) {
            return t.map((n) => this.declareVariable(n, this.variableIndex++))
              .join(`
`);
          }
          ...
          uniformDeclaration() {
            ...
            for (let { name: n, type: r, length: o } of this.uniforms)
              if (o && o > 4)
                r === "f16"
                  ? t.push(
                      `@align(16) ${n}:array<mat2x4<${r}>, ${Math.ceil(o / 8)}>`,
                    )
...
`)
          ...
          get variablesInfo() {
            if (this.uniforms.length === 0) return;
            let t = (n) =>
              [12, 10, 1, 6][["u32", "f16", "f32", "i32"].indexOf(n)];
  ...
  var cd,
    ...
    Re = E(() => {
      ...
      ((cd = (e, t) => {
        ...
        (pd = (e, t) => x.sortBasedOnPerm(e, So(e.length, t))),
        (md = (e, t, n, r) => {
    ...
    output[global_idx] = input[global_idx];
              ...
              }),
              {
                ...
                getRunData: () => {
                  let h = x.size(i);
                  return {
                    outputs: [{ dims: i, dataType: e.dataType }],
                    dispatchGroup: { x: Math.ceil(h / 64 / 4) },
                    programUniforms: [{ type: 12, data: Math.ceil(h / 4) }],
                  };
                },
                getShaderSource: d,
              }
            );
          let { newShape: l, newPerm: c } = fd(e.dims, o),
            p = x.areEqual(c, [2, 3, 1]),
            f = x.areEqual(c, [3, 1, 2]);
          if (l.length === 2 || p || f) {
            ((s = p ? [l[0], l[1] * l[2]] : f ? [l[0] * l[1], l[2]] : l),
              (a = [s[1], s[0]]));
            let h = 16;
            return (
              (d = (b) => {
              ...
              }),
              {
                ...
                getRunData: () => {
                  ...
                  return {
                    ...
                    programUniforms: [{ type: 12, data: b }, ...P(s, a)],
                  };
                },
                getShaderSource: d,
              }
  ...
  ${h.mainStart()}
    ...
    ${y.setByOffset("global_idx", b.getByIndices("aIndices"))}
            ...
            }),
            {
              ...
              getRunData: () => {
                ...
                return {
                  ...
                  programUniforms: [{ type: 12, data: h }, ...P(s, a)],
                };
              },
              getShaderSource: d,
            }
        ...
        (To = (e, t) => {
          (cd(e.inputs, t.perm), e.compute(ce(e.inputs[0], t.perm)));
        }),
        (Io = (e) => N({ perm: e.perm })));
    });
  var gd,
         ...
         if (local_idx == 0u) {
          ...
          return {
            ...
            getRunData: () => ({
              ...
              dispatchGroup: { x: u },
              programUniforms: [{ type: 12, data: d }],
            }),
          };
        }),
        (ze = (e, t, n, r) => {
          let o = e.inputs.length === 1 ? n : Hn(e.inputs, n),
            i = o.axes;
          i.length === 0 &&
            !o.noopWithEmptyAxes &&
            (i = e.inputs[0].dims.map((f, m) => m));
          let s = x.normalizeAxes(i, e.inputs[0].dims.length),
            a = s,
            u = e.inputs[0],
            d = Sd(a, e.inputs[0].dims.length);
          d.length > 0 &&
            ((u = e.compute(ce(e.inputs[0], d), {
              inputs: [0],
              outputs: [-1],
            })[0]),
            (a = wd(a.length, u.dims.length)));
          let [l, c] = $d(u.dims, a),
            p = l;
          (o.keepDims && (p = vd(l, s)),
            e.compute(Td(t, o.cacheKey, [u], r, e.inputs[0].dataType, p, c), {
              inputs: [u],
            }));
        }),
        (Co = (e, t) => {
      ...
      ((Oe = (e) => {
        ...
        (Xt = (e, t, n, r, o, i, s = !1, a = !1) => {
          let u = [],
            d = n[0].dims,
            l = d.length,
            c = x.normalizeAxes(o, l),
            p = !a && c.length === 0;
          d.forEach((b, y) => {
            p || c.indexOf(y) >= 0 ? s && u.push(1) : u.push(b);
          });
          let f = u.length,
            m = x.size(u);
          return {
...
`)
            ...
            getRunData: () => ({
              ...
              programUniforms: [{ type: 12, data: m }, ...P(d, u)],
            }),
          };
        }),
        (Hn = (e, t) => {
          ...
          return (
            e[1].dims[0] > 0 &&
              e[1].getBigInt64Array().forEach((r) => n.push(Number(r))),
            N({
              axes: n,
              keepDims: t.keepDims,
...
`)}`,
        ...
        (Uo = (e, t) => {
          Be(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes)
            ? zd(e, t)
            : Co(e, t);
        }),
        (Vo = (e, t) => {
...
var best_index : i32 = 0;`,
    ...
    Yt = E(() => {
      ...
      ((Rd = (e, t) => {
        ...
        if (t.qkvHiddenSizes.length > 0) {
          ...
          ((c = t.qkvHiddenSizes[0]),
            (p = t.qkvHiddenSizes[1]),
            (f = t.qkvHiddenSizes[2]));
        }
        let m = d;
        if (c !== p)
          throw new Error(
        ...
        return {
          ...
          vHeadSize: Math.floor(f / t.numHeads),
          numHeads: t.numHeads,
          isUnidirectional: !1,
    ...
    `),
        (Ud = (e, t, n, r, o, i, s, a) => {
          ...
          let b = (y) => {
            ...
            w && _.push(w);
            let v = a
              ? S("total_sequence_length_input", a.dataType, a.dims)
              : void 0;
            v && _.push(v);
            let $ = le(e.dataType),
              T = [
      ...
      ${
        ...
        for (var total_seq_id: u32 = seq_causal_length; total_seq_id + local_offset < uniforms.total_sequence_length; total_seq_id++) {
          ...
          return {
            ...
            getRunData: () => ({
              outputs: [],
              dispatchGroup: { x: 1, y: o, z: t * n },
              programUniforms: p,
            }),
          };
        }),
        (Vd = (e, t, n, r, o, i, s, a, u) => {
          let d = s + i.kvSequenceLength,
            l = [i.batchSize, i.numHeads, i.sequenceLength, d],
            c = e > 1 && r,
            p = i.kvNumHeads ? i.kvNumHeads : i.numHeads,
            f = c ? [i.batchSize, p, d, i.headSize] : void 0,
            m = i.nReps ? i.nReps : 1,
            h = i.scale === 0 ? 1 / Math.sqrt(i.headSize) : i.scale,
            b = X(i.headSize),
            y = i.headSize / b,
            g = 12,
            _ = {
              x: Math.ceil(d / g),
              y: Math.ceil(i.sequenceLength / g),
          ...
          let I = (A) => {
            ...
            W && R.push(W);
            let O = u
              ? S("total_sequence_length_input", u.dataType, u.dims)
              : void 0;
            O && R.push(O);
  ...
  ${A.mainStart([g, g, 1])}
    ...
    if (global_id.y < uniforms.M && global_id.x < total_sequence_length) {
      ...
      var sum: f32 = ${(() => {
        ...
        (Nd = (e, t, n, r, o, i, s = void 0, a = void 0) => {
          let u = i + o.kvSequenceLength,
            d = o.nReps ? o.nReps : 1,
            l = o.vHiddenSize * d,
            c = e > 1 && r,
            p = o.kvNumHeads ? o.kvNumHeads : o.numHeads,
            f = c ? [o.batchSize, p, u, o.headSize] : void 0,
            m = [o.batchSize, o.sequenceLength, l],
            h = 12,
            b = {
  ...
  ${$.mainStart([h, h, 1])}
   ...
   if (m < uniforms.M && n < uniforms.N) {
     ...
     output[outputIdx] = value;
        ...
        (nt = (e, t, n, r, o, i, s, a, u, d, l = void 0, c = void 0) => {
          let p = Math.min(e.outputCount, 1 + (s ? 1 : 0) + (a ? 1 : 0)),
            f = p > 1 ? d.pastSequenceLength : 0,
            m = f + d.kvSequenceLength,
            h = u && x.size(u.dims) > 0 ? u : void 0,
            b = [t, n];
          (p > 1 && s && x.size(s.dims) > 0 && b.push(s),
            h && b.push(h),
            l && b.push(l),
            c && b.push(c));
          let y = e.compute(Vd(p, t, n, s, h, d, f, l, c), {
            inputs: b,
            outputs: p > 1 ? [-1, 1] : [-1],
          })[0];
          e.compute(
            Ud(y, d.batchSize, d.numHeads, f, d.sequenceLength, m, l, c),
            { inputs: l && c ? [y, l, c] : [y], outputs: [] },
          );
          let g = [y, r];
          (p > 1 && a && x.size(a.dims) > 0 && g.push(a),
            l && g.push(l),
            c && g.push(c),
            e.compute(Nd(p, y, r, a, d, f, l, c), {
              inputs: g,
              outputs: p > 1 ? [0, 2] : [0],
            }));
        }),
        (Ld = (e, t) => {
          let n = [t.batchSize, t.numHeads, t.sequenceLength, t.headSize],
            r = t.sequenceLength,
            o = t.inputHiddenSize,
            i = t.headSize,
            s = 12,
            ...
            u = [e.inputs[0], e.inputs[1], e.inputs[2]],
            d = [
              { type: 12, data: r },
              { type: 12, data: o },
              { type: 12, data: i },
        ...
        (Wd = (e, t) => {
          let { epsilon: n, spatial: r, format: o } = t,
            ...
            y = () => {
              let _ = "";
              if (r)
                _ = `let cOffset = ${i.length === 1 ? "0u" : o === "NHWC" ? `outputIndices[${i.length - 1}] / ${s}` : "outputIndices[1]"};`;
              else if (o === "NCHW")
                _ = `
  ...
  ${l.mainStart()}
    ...
    ${u.setByOffset("global_idx", "value")}
        ...
        (ti = (e) => {
          (qd(e.inputs), e.compute(Fd(e.inputs)));
        }));
    });
  var Kd,
    J,
  ...
  ${e.mainStart()}
    ...
    ${l.setByOffset("global_idx", u)}
        ...
        (J = (e, t, n, r, o, i = e.dataType, s, a) => {
          ...
          return (
            s && u.push(...s),
            {
              ...
              getShaderSource: (d) =>
                Kd(d, x.size(e.dims), e.dataType, i, n, r, a),
              getRunData: (d) => ({
                outputs: [{ dims: e.dims, dataType: i }],
                dispatchGroup: { x: Math.ceil(x.size(d[0].dims) / 64 / 4) },
                programUniforms: u,
              }),
            }
          );
        ...
        (jd = (e) => {
          let t,
            n,
            r = e.length >= 2 && e[1].data !== 0,
            o = e.length >= 3 && e[2].data !== 0;
          switch (e[0].dataType) {
            case 1:
              ((t = r ? e[1].getFloat32Array()[0] : -34028234663852886e22),
                (n = o ? e[2].getFloat32Array()[0] : 34028234663852886e22));
              break;
            case 10:
              ((t = r ? e[1].getUint16Array()[0] : 64511),
        ...
        (pi = (e, t) => {
          let n = t || jd(e.inputs),
            r = le(e.inputs[0].dataType);
          e.compute(
            J(
              e.inputs[0],
              "Clip",
              (o) =>
                `clamp(${o}, vec4<${r}>(uniforms.min), vec4<${r}>(uniforms.max))`,
              void 0,
              n.cacheKey,
              void 0,
              [
                { type: e.inputs[0].dataType, data: n.min },
        ...
        ($i = (e, t) => {
          ...
          e.compute(
            J(
              ...
              "LeakyRelu",
              (r) =>
                `select(leaky_relu_alpha_ * ${r}, ${r}, ${r} >= vec4<${n}>(0.0))`,
        ...
        (Ti = (e) => {
          ...
          e.compute(
            J(
              e.inputs[0],
              "Relu",
              (n) => `select(vec4<${t}>(0.0), ${n}, ${n} > vec4<${t}>(0.0))`,
            ),
          );
        }),
        (Ii = (e) => {
          e.compute(
            J(e.inputs[0], "Sigmoid", (t) => `(1.0 / (1.0 + exp(-${t})))`),
          );
        }),
        (Ci = (e) => N(e)),
        (Ai = (e, t) => {
...
`),
        ...
        (Bi = (e) => {
          let t = le(e.inputs[0].dataType);
          e.compute(
            J(e.inputs[0], "FastGelu", jn, Kn(t), void 0, e.inputs[0].dataType),
          );
        }),
        (Mi = (e, t) => {
          let n = le(e.inputs[0].dataType);
          return (
            e.compute(
              J(
                ...
                "ThresholdedRelu",
                (r) =>
                  `select(vec4<${n}>(0.0), ${r}, ${r} > thresholded_relu_alpha_)`,
...
`),
  ...
  ${u.mainStart()}
    ...
    ${o.setByOffset("global_idx", "valueLeft * geluRight")}
        ...
        (Ni = (e) => {
          (Xd(e.inputs), e.compute(Yd(e.inputs)));
        }));
    });
  var Jd,
    el,
    ...
    Yi = E(() => {
      ...
      ((Jd = (e, t, n, r, o, i, s, a, u, d, l, c) => {
          ...
          if (i) {
            ...
            g || _
              ? (y = m.setByOffset(
                  ...
                  f(
                    g
                      ? `${h.type.value}(${h.getByOffset("0")}.x)`
                      : h.getByOffset("global_idx"),
                    _
        ...
        (el = (e, t, n, r, o, i, s = n.dataType) => {
          let a = n.dims.map((h) => Number(h) ?? 1),
            u = r.dims.map((h) => Number(h) ?? 1),
            d = !x.areEqual(a, u),
            l = a,
            c = x.size(a),
            p = !1,
            ...
            m = [d];
          if (d) {
            let h = Pe.calcShape(a, u, !1);
            if (!h)
              throw new Error("Can't perform binary op on the given tensors");
            ((l = h.slice()), (c = x.size(l)));
            let b = x.size(a) === 1,
              y = x.size(u) === 1,
              g = a.length > 0 && a[a.length - 1] % 4 === 0,
              _ = u.length > 0 && u[u.length - 1] % 4 === 0;
            (m.push(b), m.push(y), m.push(g), m.push(_));
            let w = 1;
          ...
          return (
            m.push(p),
            {
              ...
              getShaderSource: (h) =>
                Jd(h, a, u, l, p, d, f, o, n.dataType, r.dataType, s, i),
              getRunData: () => ({
                outputs: [{ dims: l, dataType: s }],
                dispatchGroup: { x: Math.ceil(c / 64 / 4) },
                programUniforms: [
                  { type: 12, data: Math.ceil(x.size(l) / 4) },
                  ...P(a, u, l),
                ],
              }),
            }
        ...
        (ol = (e, t) => {
          ...
          for (let o = 0; o < n; ++o) {
            ...
            n === 1
              ? r.push(i)
              : o === 0
                ? r.push(`if (inputIndex == ${o}u) { ${i} }`)
                : o === n - 1
                  ? r.push(`else { ${i} }`)
                  : r.push(`else if (inputIndex == ${o}) { ${i} }`);
          }
          return r.join(`
`);
        }),
  ...
  ${(() => {
    ...
    for (let b = 0; b < e.length; b++)
      h.registerUniform(`sizeInConcatAxis${b}`, "u32");
          ...
          let w = (v) => {
            ...
            if (h) {
              ...
              (R.push(S("bias", e[2].dataType, e[2].dims.length, G)),
                (W = `${o ? `value += bias[col / ${G}];` : `value += ${A.type.value}(bias[row + i]);`}`));
            }
            let O = [
            ...
            Ae(t, O);
            let ee = () => {
              let G = `var a_data: ${T.type.value};`;
              for (let D = 0; D < p; D++)
                G += `
              let b_data${D} = b[(b_offset + (k + ${D}) * uniforms.N + col) / ${c}];`;
              for (let D = 0; D < f; D++) {
      ...
      mm_write(batch, globalRow + innerRow, globalCol, acc[innerRow]);
        ...
        (Qn = (e, t, n = "f32", r, o = !1, i = 32, s = !1, a = 32, u = !1) => {
          ...
          if (!(p % t[1] === 0 && c % t[0] === 0 && i % t[1] === 0))
            throw new Error(
              `tileAHight ${p} must be divisible by workgroupSize[1]${t[1]}, tileAWidth ${c} must be divisible by workgroupSize[0]${t[0]}, tileInner ${i} must be divisible by workgroupSize[1]${t[1]}`,
            );
          let f = p / t[1],
            m = c / t[0],
            h = i / t[1],
...
`;
        ...
        (gt = (e, t, n, r, o = !1, i) => {
          ...
          let R = (W) => {
            ...
            let se = re(U.type.tensor),
              H = Ie(t, U.type.value, se),
              k = dl(_, M, H, [ee, D, Z, U], o);
            return `
  ${W.registerUniforms(_e)
    .registerInternalVariables(ee)
    .declareVariables(...Q, U)}
  ${k}
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${h ? `vec4<${U}>` : U}) {
        ...
        ${h ? Zn(_, g, U, void 0, !d, I) : Qn(_, g, U, void 0, !d, I, !1, void 0, a)}`;
          ...
          return {
            ...
            getRunData: () => ({
              outputs: [{ dims: u ? u(n) : n, dataType: e[0].dataType }],
              dispatchGroup: { x: w[0], y: w[1], z: w[2] },
              programUniforms: W,
            }),
            getShaderSource: ee,
          };
  ...
  var cl,
    ...
    ps = E(() => {
      ...
      ((cl = (e) => {
        ...
        (ds = (e, t, n, r, o) => {
          o == null && (o = pl(e, t[0], r[0]));
          let i = [0, 0, 0, n];
          for (let s = 0; s < 3; s++)
            e[s] + 2 * o >= t[s] &&
              (i[s] = Math.trunc((e[s] - t[s] + 2 * o) / r[s] + 1));
          return i;
        }),
        (ml = (e, t, n, r, o, i, s, a, u, d) => {
          ...
          if ((e === "VALID" && (e = 0), typeof e == "number")) {
            ...
            let m = (c - 1) * o + a - t,
              ...
              v = Math.floor(b / 2),
              $ = b - v;
            l = { top: _, bottom: w, left: v, right: $, front: y, back: g };
    ...
    ${y.setByOffset("global_idx", "value")}
        ...
        (fs = (e, t, n, r) => {
          let o = e.length > 2,
            ...
            s = X(n[2]),
            a = x.size(n) / i / s,
            u = [e[0].dims[0], e[0].dims[1], e[0].dims[2], e[0].dims[3] / i],
            d = [e[1].dims[0], e[1].dims[1], e[1].dims[2], e[1].dims[3] / i],
            l = [n[0], n[1], n[2], n[3] / i],
            c = [
              { type: 12, data: a },
  ...
  var fl,
    ...
    ys = E(() => {
      ...
      ((fl = (e, t, n, r, o, i) => {
        let s = e[0],
          a = e.slice(i ? 1 : 2, i ? 3 : 4),
          u = a.length,
          d = t[0],
          c = t.slice(2).map((m, h) => m + (m - 1) * (n[h] - 1)),
          f = a
            .map((m, h) => m + r[h] + r[h + u])
            .map((m, h) => Math.floor((m - c[h] + o[h]) / o[h]));
        ...
        (Yn = (e, t) => {
          ...
          n.length < t[1].dims.length - 2 &&
            n.push(...Array(t[1].dims.length - 2 - n.length).fill(0));
          for (let i = 2; i < t[1].dims.length; ++i)
            n[i - 2] === 0 && (n[i - 2] = t[1].dims[i]);
          let r = e.pads.slice();
          Ze.adjustPadsBasedOnAutoPad(
            t[0].dims,
            e.strides,
            e.dilations,
            n,
        ...
        (gs = (e, t, n, r) => {
          ...
          if (n.group !== 1) {
            ...
            (t.length === 3 && $.push(t[2]),
              ...
              n.dilations[0] === 1 &&
              n.dilations[1] === 1
                ? e.compute(fs($, n, i, r), { inputs: $ })
                : e.compute(ms($, n, i, r), { inputs: $ }));
            return;
          }
          let s = t.length === 3,
            a = t[0].dims[o ? 1 : 2],
            ...
            f = i[o ? 2 : 3],
            m = i[o ? 3 : 1],
            h = o && l === a && c === u && n.pads[0] === 0 && n.pads[1] === 0;
          if (
            h ||
            (l === 1 &&
              c === 1 &&
            ...
            s && z.push(t[2]);
            let M = A[2],
              R = z[0].dims[z[0].dims.length - 1];
            M < 8 && R < 8
              ? e.compute(rn(z, n, i, A, o, r), { inputs: z })
              : e.compute(gt(z, n, i, A, o, r), { inputs: z });
            return;
          }
          let b = !0,
            y =
        ...
        (gl = (e, t) => {
          ...
          let o = [0, t.pads[0], 0, t.pads[1]],
            i = [1].concat(t.strides),
            s = [1].concat(t.dilations),
            a = [1].concat(t.kernelShape),
            u = Yn(
              { ...t, pads: o, strides: i, dilations: s, kernelShape: a },
              r,
            );
        ...
        (yl = (e, t, n) => {
          ...
          e.compute(
            cs(
              ...
              o,
              s.outShape,
              [s.filterDepth, s.filterHeight, s.filterWidth],
              [s.padInfo.front, s.padInfo.top, s.padInfo.left],
              r,
            ),
          );
        }),
        (er = (e, t) => {
          if ((hl(e.inputs, t), e.inputs[0].dims.length === 3)) gl(e, t);
          else if (e.inputs[0].dims.length === 5) yl(e, e.inputs, t);
          else {
            let n = Yn(t, e.inputs);
            gs(e, e.inputs, n);
          }
  ...
  var bs,
    _s = E(() => {
      ...
      bs = (e, t, n) => {
        let r = e.length > 2,
          ...
          l = i ? X(u) : 1,
          c = i && d === 1 && u >= 4,
          p = c ? Math.floor(u / 4) * 4 : Math.floor(u / l) * l,
          f = u - p,
          m = i ? X(d) : 1,
          h = i ? (d === 1 ? l : m) : 1,
          b = x.size(o) / m,
        ...
        let g = ["rank", "rank"],
          ...
          $ = [
            w[0] +
              (t.dilations[0] <= 1
                ? 0
                : (t.kernelShape[i ? 1 : 2] - 1) * (t.dilations[0] - 1)),
            w[1] +
              (t.dilations[1] <= 1
                ? 0
                : (t.kernelShape[i ? 2 : 3] - 1) * (t.dilations[1] - 1)),
          ],
          T = [
            $[0] - 1 - Math.floor((t.pads[0] + t.pads[2]) / 2),
            $[1] - 1 - Math.floor((t.pads[1] + t.pads[3]) / 2),
          ],
          I = [
            { type: 12, data: b },
            { type: 12, data: _ },
        ...
        `),
          ...
          dotProd = dotProd + xValue * wValue;`;
            ...
            dotProd = dotProd + xValue[${k}] * wValue${k};`;
              return H;
            },
            _e = () => {
              if (f === 0) return "";
    ...
    ${se}}`;
        ...
        return {
          ...
          shaderCache: {
            hint: `${t.cacheKey};${l}${h}${m}${c}${f}`,
            inputDependencies: g,
          },
          getRunData: () => ({
            dispatchGroup: { x: y[0], y: y[1], z: y[2] },
            outputs: [{ dims: n ? n(o) : o, dataType: e[0].dataType }],
            programUniforms: I,
          }),
          getShaderSource: A,
        };
      ...
      ((bl = (e, t, n, r, o, i) => (e - 1) * t + n + (r - 1) * o + 1 - i),
        ...
        (ws = (e, t) => {
          ...
          if (
            ...
            e.kernelShape.reduce((c, p) => c * p, 1) === 0
          ) {
            n.length = 0;
          ...
          wl(a, n, u, e.autoPad, e.group, o, d, r, s, i);
        ...
        ($l = (e, t) => {
          ...
          if (
            ...
            t.dilations.length !== i
          )
            throw new Error(`dilations should be ${i}D`);
          if (
            t.strides.reduce((l, c) => l + c, 0) > 0 &&
            t.strides.length !== i
          )
        ...
        (vl = (e, t) => {
          ...
          vs(e, r, d, (l) => (n ? [l[0], l[2], l[3]] : [l[0], l[1], l[3]]));
        }),
        (xs = (e, t) => {
          if (($l(e.inputs, t), e.inputs[0].dims.length === 3)) vl(e, t);
          else {
            let n = ws(t, e.inputs);
            vs(e, e.inputs, n);
          }
  ...
  var xl,
    ...
    Cs = E(() => {
      ...
      ((xl = (e, t, n, r) => {
        ...
        (Ts = (e, t) => {
          let n = e.inputs[0].dims,
            r = e.inputs[0].dataType,
            o = e.inputs[1];
          e.compute(xl(r, n, o, t), { inputs: [0] });
        }),
        (Is = (e) => {
          let t = e.exclusive === 1,
            n = e.reverse === 1;
          return N({ exclusive: t, reverse: n });
        }));
    });
  var Sl,
    Tl,
...
`)
          ...
          u
            ? (([n, r, o, i] = e.dims),
              (s = l
                ? [n, r, o, d, d, i / d ** 2]
                : [n, r, o, i / d ** 2, d, d]),
              (a = l ? [0, 1, 3, 2, 4, 5] : [0, 1, 4, 2, 5, 3]))
            : (([n, r, o, i] = [e.dims[0], e.dims[2], e.dims[3], e.dims[1]]),
              (s = l
                ? [n, d, d, i / d ** 2, r, o]
                : [n, i / d ** 2, d, d, r, o]),
              (a = l ? [0, 3, 4, 1, 5, 2] : [0, 1, 4, 2, 5, 3]));
          let c = e.reshape(s),
            p = c.dims.length,
            f = e.dataType,
            m = S("a", f, p),
  ...
  ${y.mainStart()}
    ...
    ${h.setByOffset("global_idx", m.getByIndices("aIndices"))}
        ...
        (As = (e, t) => {
          (Sl(e.inputs), e.compute(Il(e.inputs[0], t)));
        }),
        (ks = (e) =>
          N({ blocksize: e.blocksize, mode: e.mode, format: e.format })));
    });
  var tr,
    un,
    Ps,
      ...
      ((tr = "[a-zA-Z]|\\.\\.\\."),
        ...
        (nr = class {
          ...
          addSymbol(t, n) {
            ...
            (r === void 0 ? (r = [n]) : r.push(n),
              this.symbolToIndices.set(t, r));
          }
        }),
        (rr = class {
          constructor(t, n) {
              ...
              d?.forEach((c, p) => {
                if (c === "...") {
                  ...
                  if (((a = r.slice(u, u + f)), this.hasEllipsis)) {
                    ...
                    ((this.hasEllipsis = !0), (this.ellipsisDims = a));
                  ...
                  (l.addSymbol(
                    c,
                    p + (this.hasEllipsis ? this.ellipsisDims.length - 1 : 0),
                  ),
                    this.addSymbol(c, r[u++], o));
              }),
              l
            );
          }
        ...
        (kl = (e, t, n, r) => {
          let i = e.map((l) => l.length).map((l, c) => S(`input${c}`, t, l)),
            ...
            u = [...n.symbolToInfo.keys()].filter(
              (l) => !n.rhs.symbolToIndices.has(l),
            ),
            d = (l) => {
              let c = [],
                p = "var prod = 1.0;",
                ...
                y = [],
                g = [],
                _ = n.symbolToInfo.size === n.rhs.symbolToIndices.size;
                ...
                if (n.rhs.symbolToIndices.has($)) {
                  ...
                  T !== void 0 &&
                    n.lhs.forEach((I, A) => {
                      if (v.inputIndices.includes(A)) {
                        ...
                        z.forEach((M) => {
                          c.push(
                            `${i[A].indicesSet(`input${A}Indices`, M, a.indicesGet("outputIndices", T))}`,
                          );
                        });
                      }
                    });
                  ...
                  (n.lhs.forEach((T, I) => {
                    if (v.inputIndices.includes(I)) {
                      ...
                      (A.forEach((z) => {
                        h.push(
                          `${i[I].indicesSet(`input${I}Indices`, z, `${$}`)}`,
                        );
                      }),
                        g.push(
                          `prod *= ${i[I].getByIndices(`input${I}Indices`)};`,
                        ));
                    }
                  }),
                    b.push(
                      `for(var ${$}: u32 = 0; ${$} < uniforms.${zs($)}; ${$}++) {`,
                    ),
                    y.push("}"));
              });
              let w = _
            ...
            ${i.map((v, $) => `var input${$}Indices: ${i[$].type.indices};`)
              .join(`
`)}
            ${w.join(`
`)};
          ...
          return {
            ...
            getRunData: () => {
              let l = u
                ...
                .map((p) => ({
                  type: 12,
                  data: n.symbolToInfo.get(p)?.dimValue || 0,
                }));
              l.push({ type: 12, data: s });
              let c = e
                .map((p, f) => [...P(p)])
                .reduce((p, f) => p.concat(f), l);
              return (
                c.push(...P(r)),
                {
                  outputs: [{ dims: r, dataType: t }],
        ...
        (Os = (e, t) => {
          let n = new rr(e.inputs, t.equation),
            r = n.outputDims,
            o = e.inputs.map((i, s) => i.dims);
  ...
  var El,
    ...
    Us = E(() => {
      ...
      ((El = (e) => {
        ...
        (Pl = (e, t) => (e.length > t.length ? Ms(e, t) : Ms(t, e))),
        (zl = (e) => {
          let t = e[0].dims,
            n = Array.from(e[1].getBigInt64Array(), Number),
            r = Pl(t, n),
            o = e[0].dataType,
            i = o === 9 || x.size(t) === 1,
            s = o === 9 || (t.length > 0 && t[t.length - 1] % 4 === 0) ? 4 : 1,
    ...
    ${m}`;
        ...
        (Rs = (e) => {
          (El(e.inputs), e.compute(zl(e.inputs), { inputs: [0] }));
        }));
    });
  var Ol,
    Vs,
      ...
      ${d.setByOffset("global_idx", jn("x_in"))}
        ...
        return {
          ...
          getRunData: (s) => ({
            ...
            programUniforms: [
              { type: 12, data: Math.ceil(n / 4) },
              { type: 12, data: r },
            ],
            dispatchGroup: { x: Math.ceil(n / Qe / 4) },
          }),
        };
      }),
        (Vs = (e) => {
          e.inputs.length < 2 || x.size(e.inputs[1].dims) === 0
            ? Bi(e)
            : e.compute(Ol(e.inputs));
        }));
    });
  var Dl,
    Bl,
      ...
      ((Dl = (e) => {
        ...
        (Bl = (e, t) => {
          let n = e[0].dims,
            r = e[1].dims,
            o = n.length,
            i = x.normalizeAxis(t.axis, o),
            s = n.slice(0);
          s.splice(i, 1, ...r);
          let a = n[i],
            u = e[0].dataType === 9 ? 4 : 1,
            d = Math.ceil(x.size(s) / u),
            l = [
              { type: 12, data: d },
              { type: 6, data: a },
              { type: 12, data: i },
            ...
            c = (p) => {
              let f = S("data", e[0].dataType, e[0].dims.length, u),
                ...
                b = (g) => {
                  ...
                  for (let v = 0; v < _; v++)
                    w += `${_ > 1 ? `indicesIndices${g}[${v}]` : `indicesIndices${g}`} = ${s.length > 1 ? `outputIndices${g}[uniforms.axis + ${v}]` : `outputIndices${g}`};`;
                  w += `
        ...
        `;
                  for (let v = 0, $ = 0; v < o; v++)
                    v === i
                      ? ((w += `${o > 1 ? `dataIndices${g}[${v}]` : `dataIndices${g}`} = u32(idx${g});`),
                        ($ += _))
                      : ((w += `${o > 1 ? `dataIndices${g}[${v}]` : `dataIndices${g}`} = ${s.length > 1 ? `outputIndices${g}[${$}]` : `outputIndices${g}`};`),
                        $++);
                  return w;
                },
                y;
    ...
    input_slice_offsets_data[global_idx] =  base_offset + u32(relative_slice_offset);
        ...
        (Hs = (e, t) => {
          let n = e.inputs,
            ...
            i = n[1].dims,
            s = i[i.length - 1],
            a = x.sizeToDimension(i, i.length - 1),
            u = x.sizeFromDimension(r, t.batchDims + s),
            d = x.sizeToDimension(r, t.batchDims),
            l = x.sizeFromDimension(r, t.batchDims),
            c = a / d,
            p = new Array(s),
            f = u;
          for (let w = 0; w < s; ++w)
            ((p[s - 1 - w] = f), (f *= r[t.batchDims + s - 1 - w]));
          let m = Ml(e, n[1], p, t.batchDims, r, a, c, l, s),
            h = t.batchDims + s;
          if (h > r.length)
            throw new Error(
  ...
  var Rl,
    ...
    Zs = E(() => {
      ...
      ((Rl = (e, t) => {
        ...
        if (
          i.dims.length !== o.dims.length ||
          !o.dims
            .map((a, u) =>
              u === n ? Math.ceil(a / r) === i.dims[u] : a === i.dims[u],
            )
            .reduce((a, u) => a && u, !0)
        )
          throw new Error(
        ...
        (Ul = (e, t) => {
          let n = e[0].dims,
            r = e[1].dims,
            o = n.length,
            i = x.normalizeAxis(t.gatherAxis, o),
            s = x.normalizeAxis(t.quantizeAxis, o),
            a = n.slice(0);
          a.splice(i, 1, ...r);
          let u = x.size(a),
            d = e[2].dataType,
            ...
            f = (m) => {
              let h = S("data", e[0].dataType, e[0].dims.length),
                ...
                g =
                  e.length > 3
                    ? S("zeroPoint", e[3].dataType, e[3].dims.length)
                    : void 0,
        ...
        (Ks = (e, t) => {
          let n = e.inputs;
          (Rl(n, t), e.compute(Ul(e.inputs, t)));
        }),
        (js = (e) =>
          N({
      ...
      ((Ll = (e) => {
        ...
        (Gl = (e, t) => {
          ...
          let u = 16,
            ...
            m = ["type", "type"];
          (e.length === 3 && (f.push(...P(e[2].dims)), m.push("rank")),
            f.push(...P(a)));
          let h = (y) => {
              let g = "";
              t.transA && t.transB
              ...
              let _ = t.alpha === 1 ? "" : "value *= uniforms.alpha;",
                ...
                I = [w, v];
              e.length === 3 &&
                ((T = S("c", e[2].dataType, e[2].dims.length)), I.push(T));
    ...
    output[global_idx] = value;
            ...
            b = (y) => {
              let g = S("a", e[0].dataType, e[0].dims),
                ...
                v = [g, _];
              e.length === 3 &&
                ((w = S("c", e[2].dataType, e[2].dims.length)), v.push(w));
      ...
      `),
                  (I =
                    "value += tile_a[k][local_id.y] * tile_b[local_id.x][k];"))
                : t.transA && !t.transB
                  ? ((A = `
      var col = tile_row_start + local_id.x;
      var row = k_start + local_id.y;
  ...
  ${y.mainStart([u, u, 1])}
    ...
    if (m < uniforms.M && n < uniforms.N) {
      output[m * uniforms.N + n] = value;
        ...
        (ea = (e, t) => {
          (Ll(e.inputs), e.compute(Gl(e.inputs, t)));
        }));
    });
  var Ue,
    qe,
    ...
    oa = E(() => {
      ...
      (([Ue, qe, rt, ot] = [0, 1, 2, 3]),
        (Wl = (e) => {
          ...
          if (e[0].dims.length !== e[1].dims.length)
            throw new Error(
              "input dimensions must be equal to grid dimensions",
            );
  ...
  fn pixel_at_grid(r: i32, c: i32, H: i32, W: i32, batch: u32, channel: u32, border: vec4<f32>) -> ${t} {
     ...
     indices[${qe}] = channel;` +
        ...
        `;
              default:
                throw new Error(
                  `padding mode ${n.paddingMode} is not supported`,
                );
            }
          })() +
          `
...
`),
      ...
      ${Zl(s, a, t)}
          ...
          return {
            ...
            getRunData: (c) => {
              let p = x.size(i);
              return {
                outputs: [{ dims: i, dataType: c[0].dataType }],
                dispatchGroup: { x: Math.ceil(p / 64) },
                programUniforms: d,
              };
            },
        ...
        (na = (e, t) => {
          (Wl(e.inputs), e.compute(Ql(e.inputs, t)));
        }),
        (ra = (e) =>
          N({
  ...
  var he,
    ...
    or = E(() => {
      ...
      K();
      Re();
      ((he = (e, t) => (e.length > t && e[t].dims.length > 0 ? e[t] : void 0)),
        (Jl = (e, t) => {
          let n = e[0],
            r = he(e, 1),
            o = he(e, 2),
          ...
          if (u && d && x.size(u.dims) && x.size(d.dims)) {
            ...
            if (u.dims[0] !== l || u.dims[1] !== t.numHeads || u.dims[3] !== b)
              throw new Error(
                'Input "past_key" shape (batch_size, num_heads, past_sequence_length, head_size)',
              );
            if (d.dims[0] !== l || d.dims[1] !== t.numHeads || d.dims[3] !== b)
              throw new Error(
          ...
          if (r && x.size(r.dims) > 0) {
            ...
            if (r.dims.length === 3) {
              ...
              if (r.dims[1] !== t.numHeads || r.dims[3] !== b)
                throw new Error(
        ...
        (yt = (e, t, n, r, o, i, s, a) => {
          ...
          if (s && x.size(s.dims) > 0) {
            ...
            return (
              ...
              n === 1 || r === 1
                ? u
                : e.compute(ce(u, ia.perm), { inputs: [u], outputs: [-1] })[0]
            );
          } else
            return (
              i.dims.length === 3 && (u = i.reshape([t, r, n, o])),
              n === 1 || r === 1
                ? u
                : e.compute(ce(u, ia.perm), { inputs: [u], outputs: [-1] })[0]
            );
    ...
    sr = E(() => {
      ...
      ((tc = (e) => {
        ...
        (nc = (e, t) => {
          ...
          return (
            e[1].dims[0] > 0 &&
              (e[1].getBigInt64Array().forEach((o) => n.push(Number(o))),
              (r = n.length)),
            N({ numOutputs: r, axis: t.axis, splitSizes: n })
          );
        }),
        (rc = (e) => `
        ...
        (oc = (e) => {
          ...
          for (let r = 0; r < t; ++r) {
            ...
            t === 1
              ? n.push(o)
              : r === 0
                ? n.push(`if (output_number == ${r}u) { ${o} }`)
                : r === t - 1
                  ? n.push(`else { ${o} }`)
                  : n.push(`else if (output_number == ${r}) { ${o} }`);
          }
          return `
...
`)}
        ...
        (ir = (e, t) => {
          ...
          for (let m = 0; m < t.numOutputs; m++) {
            ...
            ((h[i] = t.splitSizes[m]),
              l.push(h),
              (s[m] = C(`output${m}`, o, h.length)),
              d.push({ dims: l[m], dataType: e[0].dataType }));
          }
  ...
  ${m.mainStart()}
    ...
    writeBufferData(output_number, indices, global_idx);
        ...
        (ua = (e, t) => {
          tc(e.inputs);
          let n = e.inputs.length === 1 ? t : nc(e.inputs, t);
          e.compute(ir(e.inputs, n), { inputs: [0] });
        }),
        (da = (e) => {
          let t = e.axis,
            n = e.splitSizes,
  ...
  var ic,
    ...
    ar = E(() => {
      ...
      ((ic = (e, t) => {
        let [n, r, o, i] = e,
          { numHeads: s, rotaryEmbeddingDim: a } = t;
        if (n.dims.length !== 3 && n.dims.length !== 4)
          throw new Error(
            `Input 'x' is expected to have 3 or 4 dimensions, got ${n.dims.length}`,
          );
        if (
          !x.areEqual(r.dims, []) &&
          !x.areEqual(r.dims, [1]) &&
          ...
          throw new Error(
            `Input 'position_ids' is expected to have 0, 1, or 2 dimensions, got ${r.dims.length}`,
          );
        if (o.dims.length !== 2)
          throw new Error(
            `Input 'cos_cache' is expected to have 2 dimensions, got ${o.dims.length}`,
          );
        if (i.dims.length !== 2)
          throw new Error(
            `Input 'sin_cache' is expected to have 2 dimensions, got ${i.dims.length}`,
          );
        ...
        if (r.dims.length === 2) {
          if (u !== r.dims[0])
            throw new Error(
              `Input 'position_ids' dimension 0 should be of size batch_size, got ${r.dims[0]}`,
            );
          if (d !== r.dims[1])
            throw new Error(
              `Input 'position_ids' dimension 1 should be of size sequence_length, got ${r.dims[1]}`,
            );
        }
        if (p / 2 !== o.dims[1] && a / 2 !== o.dims[1])
          throw new Error(
            `Input 'cos_cache' dimension 1 should be same as head_size / 2 or rotary_embedding_dim / 2, got ${o.dims[1]}`,
          );
        if (d > l)
          throw new Error(
        ...
        (dn = (e, t) => {
          let {
              interleaved: n,
              numHeads: r,
              rotaryEmbeddingDim: o,
              scale: i,
            } = t,
            s = e[0].dims[0],
            a = x.sizeFromDimension(e[0].dims, 1),
            u = e[0].dims[e[0].dims.length - 2],
            d = a / u,
            l = e[2].dims[1],
            c = o === 0 ? l * 2 : d / r,
            p = new Array(s, u, d / c, c - l),
            f = x.computeStrides(p),
            m = [
              { type: 1, data: i },
              { type: 12, data: p },
              { type: 12, data: f },
              ...(e[0].dims.length === 3
                ? new Array({ type: 12, data: [a, d, c, 1] })
                : []),
              ...(e[0].dims.length === 4
                ? new Array({ type: 12, data: [a, c, u * c, 1] })
                : []),
        ...
        ${b.mainStart(Qe)}
          ...
          return {
            ...
            getRunData: () => ({
              outputs: [{ dims: e[0].dims, dataType: e[0].dataType }],
              dispatchGroup: { x: Math.ceil(x.size(p) / Qe) },
              programUniforms: m,
            }),
          };
        }),
        (la = (e, t) => {
          (ic(e.inputs, t), e.compute(dn(e.inputs, t)));
        }));
    });
  var sc,
    ac,
    ...
    ma = E(() => {
      ...
      ((sc = (e, t) => {
        ...
        let a = !1,
          ...
          f = !r || r.dims.length === 0,
          m = Math.floor(
            f ? l / (t.numHeads + 2 * t.kvNumHeads) : l / t.numHeads,
          );
        f && (l = m * t.numHeads);
        let h = i && i.dims.length !== 0,
          b = s && s.dims.length !== 0;
        if (
          h &&
          i.dims.length === 4 &&
          i.dims[0] === u &&
          i.dims[1] !== t.kvNumHeads &&
        ...
        if (r && r.dims.length > 0) {
          ...
          if (
            n.dims.length === 5 &&
            (n.dims[2] !== t.numHeads || n.dims[3] !== 3)
          )
            throw new Error(
              'Expect "query" shape (batch_size, kv_sequence_length, num_heads, 3, head_size) for packed kv',
            );
        ...
        let _ = 0,
          w = !1,
          v = t.kvNumHeads ? m * t.kvNumHeads : l;
        ...
        return {
          ...
          vHiddenSize: v,
          headSize: m,
          vHeadSize: Math.floor(v / t.kvNumHeads),
          numHeads: t.numHeads,
  ...
  `;
        ...
        (pa = (e, t) => {
          ...
          let r = e.inputs[0],
            o =
              e.inputs[1] && e.inputs[1].dims.length > 0 ? e.inputs[1] : void 0,
            i =
              e.inputs[2] && e.inputs[2].dims.length > 0 ? e.inputs[2] : void 0,
            s =
              e.inputs[3] && e.inputs[3].dims.length !== 0
                ? e.inputs[3]
                : void 0,
            a =
              e.inputs[4] && e.inputs[4].dims.length !== 0
                ? e.inputs[4]
                : void 0,
            u = e.inputs.length > 4 ? e.inputs[5] : void 0,
            d = e.inputs.length > 5 ? e.inputs[6] : void 0,
            l = n.kvNumHeads ? n.kvNumHeads : n.numHeads,
            c = N({
              axis: 2,
              numOutputs: 3,
              splitSizes: [
            ...
            [p, f, m] =
              !o && !i
                ? e.compute(ir([r], c), { inputs: [r], outputs: [-1, -1, -1] })
                : [r, o, i],
            h,
            b;
          if (t.doRotary) {
            let w = e.compute(uc(n.batchSize, n.sequenceLength, u, d), {
                inputs: [u, d],
                outputs: [-1],
              })[0],
              v = e.inputs[7],
              ...
              I = [p, w, v, $],
              A = [-1];
            ((h = e.compute(dn(I, T), { inputs: I, outputs: A })[0]),
              I.splice(0, 1, f));
            let z = N({
              interleaved: t.rotaryInterleaved !== 0,
            ...
            b = e.compute(dn(I, z), { inputs: I, outputs: A })[0];
          }
          let y = yt(
              e,
              n.batchSize,
            ...
            g = ca(e, t.doRotary ? b : f, n),
            _ = ca(e, m, n);
          nt(e, y, g, _, void 0, void 0, s, a, void 0, n, u, d);
        }));
    });
  var fa,
    dc,
  ...
  ${b.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
      ...
      ${_.setByOffset("global_idx", "value")};
          ...
          e.compute(
            {
              ...
              getRunData: () => ({
                ...
                dispatchGroup: { x: Math.ceil(l / 64) },
                programUniforms: [{ type: 12, data: l }, ...P(p, f, p)],
              }),
              getShaderSource: h,
            },
            { inputs: [t[0], c] },
        ...
        (lc = (e, t, n) => {
          ...
          p = p && r[r.length - 1] !== 1;
          let m = p
              ? e.compute(ce(e.inputs[0], f), {
                  inputs: [e.inputs[0]],
                  outputs: [-1],
                })[0]
              : e.inputs[0].reshape(
                  Array.from({ length: r.length }, (y, g) => r[f[g]]),
                ),
                ...
                w = (T) => {
                  ...
                  switch (u) {
                    case 1:
                      return `${g}(${A}(scale.${I}))`;
                    case 2:
                      return `vec2<${g}>(${A}(scale[0].${I}, scale[1].${I}))`;
                    case 4:
                      return `vec4<${g}>(${A}(scale[0].${I}, scale[1].${I}, scale[2].${I}, scale[3].${I}))`;
                    default:
      ...
      ((cc = (e) => {
        ...
        (pc = (e, t, n) => {
          let r = t.simplified,
            ...
            s = !r && e[2],
            a = o,
            u = x.normalizeAxis(t.axis, o.length),
            d = x.sizeToDimension(o, u),
            l = x.sizeFromDimension(o, u),
            c = x.size(i.dims),
            p = s ? x.size(s.dims) : 0;
          if (c !== l || (s && p !== l))
       ...
       Got scale size of ${c} and bias size of ${p}`);
          ...
          let y = n > 1,
            ...
            _ = (v) => {
              let $ = re(e[0].dataType),
                T = [
                  S("x", e[0].dataType, e[0].dims, m),
                  S("scale", i.dataType, i.dims, m),
                ];
  ...
  ${v.mainStart()}
    ...
    ${g ? "inv_std_output[global_idx] = inv_std_dev" : ""};
        ...
        (ya = (e, t) => {
          (cc(e.inputs), e.compute(pc(e.inputs, t, e.outputCount)));
        }));
    });
  var mc,
    _a,
    wa = E(() => {
      ...
      ((mc = (e) => {
        ...
        (_a = (e) => {
          mc(e.inputs);
          let t = Pe.calcShape(e.inputs[0].dims, e.inputs[1].dims, !0);
          ...
          if (n < 8 && r < 8) e.compute(rn(e.inputs, { activation: "" }, t));
            ...
            let o = t[t.length - 2],
              ...
              s = x.size(e.inputs[1].dims.slice(0, -2));
            if (i !== 1 && o === 1 && s === 1) {
              let a = e.inputs[0].reshape([1, i, r]),
      ...
      ((fc = (e, t) => {
        ...
        (hc = (e, t) => {
          let n = e[0].dims,
            ...
            _ = [],
            w = [u, o, i / p],
            v = x.convertShape(e[1].dims).slice();
          (v.splice(-1, 1, l / f),
            _.push(...P(w)),
            _.push(...P(v)),
            _.push(...P(e[2].dims)),
            e.length === 4 && _.push(...P(x.convertShape(e[3].dims))));
          let $ = [u, o, s / m];
          _.push(...P($));
          let T = (I) => {
            let A = w.length,
              ...
              O =
                e.length === 4
                  ? S("zero_points", 12, e[3].dims.length)
                  : void 0;
            O && W.push(O);
            let ee = $.length,
          ...
          `;
            ...
            b_dequantized_values = ${
              p === 1
                ? `${Z}(${Array.from({ length: 8 }, (k, L) => `(b_quantized_values[${L}] - ${O ? `zero_point${H}` : "zero_point"}) * scale${H}`).join(", ")});`
        ...
        (gc = (e, t) => {
          let n = e[0].dims,
            ...
            $ = [],
            T = [u, o, i / p],
            I = x.convertShape(e[1].dims).slice();
          (I.splice(-1, 1, l / f),
            $.push(...P(T)),
            $.push(...P(I)),
            $.push(...P(e[2].dims)),
            e.length === 4 && $.push(...P(x.convertShape(e[3].dims))));
          let A = [u, o, s];
          $.push(...P(A));
          let z = (M) => {
            let R = T.length,
          ...
          let a_data1 = vec4<${Q}>(sub_a[word_offset + 4], sub_a[word_offset + 5], sub_a[word_offset + 6], sub_a[word_offset + 7]);`;
                  case 2:
                    return `
          let a_data0 = vec4<${Q}>(sub_a[word_offset], sub_a[word_offset + 1]);
          let a_data1 = vec4<${Q}>(sub_a[word_offset + 2], sub_a[word_offset + 3]);`;
                  case 4:
                    return `
  ...
  var yc,
    ...
    Ta = E(() => {
      ...
      `;
        ...
        (xc = (e, t) => {
          let n = x.padShape(e[0].dims.slice(), t.pads),
            r = e[0].dims,
            o = x.size(n),
            i = [
              { type: 12, data: o },
          ...
          (t.mode === 0 &&
            i.push({ type: s ? e[2].dataType : 1, data: t.value }),
            i.push(...P(e[0].dims, n)));
          let a = ["rank"],
            u = (d) => {
              ...
              return (
                t.mode === 0 &&
                  m.push({ name: "constant_value", type: s ? p : "f32" }),
                `
          ...
          return {
            ...
            getRunData: () => ({
              outputs: [{ dims: n, dataType: e[0].dataType }],
              dispatchGroup: { x: Math.ceil(x.size(n) / 64) },
              programUniforms: i,
            }),
            getShaderSource: u,
          };
            ...
            let n = e[1].getBigInt64Array(),
              r =
                e.length >= 3 && e[2].data
                  ...
                  : 0,
              o = e[0].dims.length,
              i = new Int32Array(2 * o).fill(0);
            if (e.length >= 4) {
              let a = e[3].getBigInt64Array();
              for (let u = 0; u < a.length; u++)
                ((i[Number(a[u])] = Number(n[u])),
                  (i[Number(a[u]) + o] = Number(n[u + a.length])));
            } else n.forEach((a, u) => (i[Number(u)] = Number(a)));
            let s = [];
            return (
              i.forEach((a) => s.push(a)),
              { mode: t.mode, value: r, pads: s }
            );
          } else return t;
        }),
        (Sa = (e, t) => {
          yc(e.inputs);
          let n = Sc(e.inputs, t);
          e.compute(xc(e.inputs, n), { inputs: [0] });
        }));
    });
  var ln,
    Ia,
      ...
      ((ln = (e) => {
        ...
        (Ia = (e, t, n) => {
          ...
          let i = Object.hasOwnProperty.call(t, "dilations"),
            ...
            d = t.pads.slice();
          Ze.adjustPoolAttributes(n, o, s, a, u, d);
          let l = Ze.computePoolOutputShape(n, o, a, u, s, d, t.autoPad),
            c = Object.assign({}, t);
          i
            ? Object.assign(c, {
                kernelShape: s,
        ...
        (Ca = (e, t) => {
          ...
          if (t.kernelShape.length <= 2) {
            let a = t.kernelShape[t.kernelShape.length - 1],
              u = t.strides[t.strides.length - 1],
        ...
        (Pa = (e, t, n, r) => {
          ...
          return {
            name: e,
            shaderCache: {
              hint: `${r.cacheKey};${p};${f};${m}`,
              inputDependencies: h,
            },
            getRunData: () => ({
              outputs: [{ dims: i, dataType: t.dataType }],
              dispatchGroup: { x: Math.ceil(x.size(i) / 64) },
              programUniforms: l,
            }),
            getShaderSource: (b) =>
              Aa(b, s, t.dims.length, i.length, o, u, d, 0, c, p, f, m),
          };
        }),
        (za = (e) => {
        ...
        (Ma = (e, t) => {
          (ln(e.inputs),
            e.compute(Pa("GlobalAveragePool", e.inputs[0], !0, t)));
        }),
        (Ra = (e, t, n, r) => {
          let [o, i] = Ia(t, r, n),
            s = `
    ...
    qa = E(() => {
      ...
      ((Ac = (e, t) => {
        ...
        if (t.blockSize > 0) {
          ...
          let n = e[0].dims[t.axis],
            r = e[1].dims[t.axis];
          if (
            t.blockSize < Math.ceil(n / r) ||
            t.blockSize > Math.ceil(n / (r - 1) - 1)
          )
            throw new Error(
        ...
        (kc = (e, t) => {
          let n = x.normalizeAxis(t.axis, e[0].dims.length),
            r = e[0].dataType,
            o = r === 3,
            i = e[0].dims,
            s = e[1].dataType,
            a = x.size(i),
            u = r === 3 || r === 2,
            d = u ? [Math.ceil(x.size(e[0].dims) / 4)] : e[0].dims,
            l = e[1].dims,
            c = e.length > 2 ? e[2] : void 0,
            p = c ? (u ? [Math.ceil(x.size(c.dims) / 4)] : c.dims) : void 0,
            f = l.length === 0 || (l.length === 1 && l[0] === 1),
            m = f === !1 && l.length === 1,
            h = X(a),
            b = f && (!u || h === 4),
            y = b ? h : 1,
      ...
      ${$.setByOffset("global_idx", `${$.type.value}(x_value - zero_point_value) * scale_value`)};
          ...
          return {
            ...
            getShaderSource: z,
            getRunData: () => ({
              outputs: [{ dims: i, dataType: s }],
              dispatchGroup: { x: Math.ceil(a / y / 64), y: 1, z: 1 },
              programUniforms: A,
            }),
          };
        }),
        (Wa = (e, t) => {
          (Ac(e.inputs, t), e.compute(kc(e.inputs, t)));
        }),
        (Ha = (e) => N({ axis: e.axis, blockSize: e.blockSize })));
    });
  var Ec,
    Pc,
    Fa,
    Ka = E(() => {
      ...
      ((Ec = (e, t, n) => {
        ...
        (Pc = (e, t, n, r) => {
          let o = Math.abs(Math.ceil((t - e) / n)),
            i = [o],
            s = o,
            a = [
              { type: 12, data: s },
        ...
        (Fa = (e) => {
          ...
          (e.inputs[0].dataType === 6
            ? ((t = e.inputs[0].getInt32Array()[0]),
              (n = e.inputs[1].getInt32Array()[0]),
              (r = e.inputs[2].getInt32Array()[0]))
            : e.inputs[0].dataType === 1 &&
              ((t = e.inputs[0].getFloat32Array()[0]),
              (n = e.inputs[1].getFloat32Array()[0]),
              (r = e.inputs[2].getFloat32Array()[0])),
            te.webgpu.validateInputContent && Ec(t, n, r),
            e.compute(Pc(t, n, r, e.inputs[0].dataType), { inputs: [] }));
        }));
    });
  var zc,
    ja,
    ...
    data_offset += u32((u32(index) * element_count_dim));`),
        ...
        (Oc = (e, t) => {
          let n = e[0].dims,
            ...
            o = n,
            i = 1,
            s = Math.ceil(x.size(r) / i),
            a = r[r.length - 1],
            u = x.sizeFromDimension(n, a),
            d = x.sizeFromDimension(r, 0) / a,
            l = [
              { type: 12, data: s },
              { type: 12, data: a },
              { type: 12, data: u },
  ...
  ${Za(t, h.type.value, !0)}
        ...
        (Qa = (e) => N({ reduction: e.reduction })),
        (Xa = (e, t) => {
          e.compute(Oc(e.inputs, t), {
  ...
  var Dc,
    ...
    ru = E(() => {
      ...
      ((Dc = (e, t) => {
        ...
        (Mc = (e, t, n, r, o, i) => {
          let [s, a, u] = n > 10 ? [1, 2, 3] : [-1, e.length > 1 ? 1 : -1, -1],
            d = e[0].dims.length;
          ...
          if (
            ...
            if (
              (e[a].getFloat32Array().forEach((l) => r.push(l)),
              r.length !== 0 &&
                r.length !== d &&
                n >= 18 &&
                r.length !== t.axes.length)
            )
              throw new Error(
            ...
            (Dc(r, t),
              t.axes.length > 0 &&
                Bc(r, t.axes, d).forEach((l, c) => (r[c] = l)));
          }
          if (
            u > 0 &&
            e.length > u &&
            e[u].dims.length === 1 &&
            e[u].dims[0] > 0 &&
            (e[u].getBigInt64Array().forEach((l) => o.push(Number(l))),
            o.length !== 0 &&
              o.length !== d &&
              n >= 18 &&
              o.length !== t.axes.length)
          )
            throw new Error(
        ...
        (Lc = (e, t, n) => {
          let r = (() => {
            switch (n.keepAspectRatioPolicy) {
              ...
              default:
                throw new Error(
                  `Keep aspect ratio policy ${n.keepAspectRatioPolicy} is not supported`,
                );
            }
          })();
          t.fill(1, 0, t.length);
          ...
          return (
            n.axes.length > 0
              ? (n.axes.forEach((i) => (t[i] = r)),
                n.axes.forEach((i) => (o[i] = Math.round(e[i] * t[i]))))
              : (t.fill(r, 0, t.length),
                o.forEach((i, s) => (o[s] = Math.round(i * t[s])))),
            o
          );
        }),
        (Gc = (e, t, n, r, o) => `
...
`
  ...
  fn bicubicInterpolation(output_indices: ${t.type.indices}) -> ${m} {
    ...
    `;
        ...
        (Kc = (e, t, n, r, o) => {
          let [s, a, u, d, l] =
              n.length === 3 ? [-1, 0, 1, 2, -1] : [0, 2, 3, 4, 1],
            c = e.type.value;
          return `
...
`
          ...
          return {
            name: "Resize",
            shaderCache: {
              hint: `${t.cacheKey}|${n}|${d.length > 0 ? (t.mode === "cubic" ? d : d.length) : ""}|${o.length > 0 ? o : ""}|${a.length > 0 ? a : ""}|${f}|${t.mode === "nearest" ? s.length : s}`,
              inputDependencies: ["rank"],
            },
            getShaderSource: y,
            getRunData: () => ({
              outputs: [{ dims: u, dataType: e.dataType }],
              dispatchGroup: { x: Math.ceil(p / 64) },
              programUniforms: [
                { type: 12, data: p },
                { type: 1, data: d },
        ...
        (tu = (e, t) => {
          ...
          (Mc(e.inputs, t, i, n, r, o),
            e.compute(jc(e.inputs[0], t, i, n, r, o), { inputs: [0] }));
        }),
        (nu = (e) => {
          let t = e.antialias,
            n = e.axes,
            r = e.coordinateTransformMode,
            o = e.cubicCoeffA,
            i = e.excludeOutside !== 0,
      ...
      ${v.mainStart([b, 1, 1])}
        ...
        (ou = (e, t) => {
          ...
          (e.outputCount > 1 && r.push(-3),
            ...
            e.compute(Xc(e.inputs, t, e.outputCount, !1), { outputs: r }));
        }));
    });
  var Yc,
    cn,
    ...
    du = E(() => {
      ...
      ((Yc = (e, t) => {
        ...
        (Jc = (e, t) => {
          if (e.length > 1) {
            let n = cn(e, 1),
              ...
              o = cn(e, 3);
            return (
              o.length === 0 && (o = [...Array(e[0].dims.length).keys()]),
              N({ starts: n, ends: r, axes: o })
            );
          } else return t;
        }),
        (su = (e, t, n, r, o) => {
          ...
          return (
            e < 0 && (i += n[r[t]]),
            o[t] < 0
              ? Math.max(0, Math.min(i, n[r[t]] - 1))
              : Math.max(0, Math.min(i, n[r[t]]))
          );
        }),
        (ep = (
          e,
        ...
        (tp = (e, t) => {
          let n = e[0].dims,
            ...
            o =
              t.axes.length > 0
                ? x.normalizeAxes(t.axes, n.length)
                : [...Array(n.length).keys()],
            i = cn(e, 4);
          (i.forEach(
            (y) =>
          ...
          if (o.length !== n.length)
            for (let y = 0; y < n.length; ++y)
              o.includes(y) ||
                (s.splice(y, 0, 0), a.splice(y, 0, n[y]), i.splice(y, 0, 1));
      ...
      ${y.registerUniforms(m).declareVariables(p, c)}
        ...
        (au = (e, t) => {
          Yc(e.inputs, t);
          let n = Jc(e.inputs, t);
          e.compute(tp(e.inputs, n), { inputs: [0] });
        }),
        (uu = (e) => {
          let t = e.starts,
            n = e.ends,
            r = e.axes;
          return N({ starts: t, ends: n, axes: r });
        }));
    });
  var np,
    rp,
      ...
      ((np = (e) => {
        ...
        (rp = (e, t) => {
          let n = e.inputs[0],
            ...
            o = x.size(r),
            i = r.length,
            s = x.normalizeAxis(t.axis, i),
            a = s < r.length - 1,
            u,
            d = [];
          a
            ? ((d = Array.from({ length: i }, (T, I) => I)),
              (d[s] = i - 1),
              (d[i - 1] = s),
              (u = e.compute(ce(n, d), { inputs: [n], outputs: [-1] })[0]))
            : (u = n);
          let l = u.dims,
            c = l[i - 1],
            p = o / c,
        ...
        for (var col = lindex; col < cols; col += wg) {
          ...
          setValue(row, col, row_stride, value);
            ...
            $ = e.compute(
              ...
              { inputs: [u], outputs: [a ? -1 : 0] },
            )[0];
          a && e.compute(ce($, d), { inputs: [$] });
        }),
        (lu = (e, t) => {
          (np(e.inputs), rp(e, t));
        }),
      ...
      ${u.setByOffset("global_idx", a.getByIndices("input_indices"))}
          ...
          return {
            ...
            getRunData: () => ({
              outputs: [{ dims: o, dataType: e[0].dataType }],
              dispatchGroup: { x: Math.ceil(i / 64) },
              programUniforms: [{ type: 12, data: i }, ...P(e[0].dims, o)],
            }),
            getShaderSource: d,
          };
        }),
        (fu = (e) => {
          (op(e.inputs), e.compute(sp(e.inputs), { inputs: [0] }));
        }));
    });
  var ap,
    up,
      ...
      ((ap = (e, t, n, r, o) => {
        ...
        if (!r)
          d = i.setByOffset(
            "global_idx",
            l(
              s.getByOffset("global_idx"),
              a.getByOffset("global_idx"),
              u.getByOffset("global_idx"),
            ),
          );
        else {
          let c = (p, f, m = "") => {
        ...
        (up = (e) => {
          let t = e[1].dims,
            ...
            r = e[0].dims,
            o = e[1].dataType,
            i = !(x.areEqual(t, n) && x.areEqual(n, r)),
            s = t,
            a = x.size(t);
          if (i) {
            let d = Pe.calcShape(Pe.calcShape(t, n, !1), r, !1);
            if (!d)
          ...
          return {
            ...
            getRunData: () => ({
              outputs: [{ dims: s, dataType: o }],
              dispatchGroup: { x: Math.ceil(a / 64 / 4) },
              programUniforms: [{ type: 12, data: u }, ...P(r, t, n, s)],
            }),
          };
        }),
        (gu = (e) => {
          e.compute(up(e.inputs));
        }));
    });
  var bu,
    _u = E(() => {
  ...
  var pn,
    wu = E(() => {
      ...
      pn = class {
        ...
        run(t, n, r, o, i) {
          fe(t.programInfo.name);
          let s = this.backend.device,
            a = this.backend.getComputePassEncoder();
          ...
          (a.setPipeline(t.computePipeline),
            a.setBindGroup(0, d),
        ...
        build(t, n) {
          ...
          let s = xo(n, this.backend.device.limits),
        ...
        (dr = class {
          ...
          async initialize(t, n) {
              ...
              o = {
                requiredLimits: {
                  maxComputeWorkgroupStorageSize:
                    n.limits.maxComputeWorkgroupStorageSize,
                  maxComputeWorkgroupsPerDimension:
                    n.limits.maxComputeWorkgroupsPerDimension,
                  maxStorageBufferBindingSize:
                    n.limits.maxStorageBufferBindingSize,
            ...
            (i("chromium-experimental-timestamp-query-inside-passes") ||
              ...
              (this.adapterInfo = new ur(
                n.info || (await n.requestAdapterInfo()),
              )),
              (this.gpuDataManager = wo(this)),
              (this.programManager = new pn(this)),
              ...
              this.queryType !== "none" &&
                t.mapAsync(GPUMapMode.READ).then(() => {
                  ...
                  for (let o = 0; o < n.length / 2; o++) {
                    let i = r[o],
                      s = i.kernelId,
                      a = this.kernels.get(s),
                      u = a.kernelType,
                      d = a.kernelName,
                      l = i.programName,
                      c = i.inputTensorViews,
                    ...
                    if (this.env.webgpu.profiling?.ondata)
                      this.env.webgpu.profiling.ondata({
                        version: 1,
                        inputsMetadata: c.map((y) => ({
                          dims: y.dims,
                          dataType: ke(y.dataType),
                        })),
                        outputsMetadata: p.map((y) => ({
                          dims: y.dims,
                          dataType: ke(y.dataType),
                        })),
                        kernelId: s,
                      ...
                      (p.forEach((_, w) => {
                        ...
                        console.log(
                          `[profiling] kernel "${s}|${u}|${d}|${l}" ${y}${g}execution time: ${b - h} ns`,
                        ));
                    }
                    dt("GPU", `${l}::${f}::${m}`);
                  }
          ...
          run(t, n, r, o, i, s) {
            ...
            let {
              ...
              c = r.length === 0 ? u.map((_, w) => w) : r;
            if (c.length !== u.length)
              throw new Error(
                `Output size ${c.length} must be equal to ${u.length}.`,
              );
            let p = [],
              f = [];
            for (let _ = 0; _ < u.length; ++_) {
              if (!Number.isInteger(c[_]) || c[_] < -3 || c[_] >= s)
                throw new Error(`Invalid output index: ${c[_]}`);
              if (c[_] === -3) continue;
              let w = c[_] === -1,
                v = c[_] === -2,
                $ =
                  w || v
                    ? i(u[_].dataType, u[_].dims)
                    : o(c[_], u[_].dataType, u[_].dims);
              ...
              if ((w && this.temporaryData.push(T), v)) {
                ...
                (I ||
                  ((I = []),
                  this.kernelPersistentData.set(this.currentKernelId, I)),
                  I.push(T));
              }
              f.push(T);
            }
            if (a.length !== n.length || f.length !== p.length) {
              if (f.length === 0) return (me(t.name), p);
              throw new Error(
            ...
            if (l) {
              ...
              l.forEach((I) => {
                ...
                let z = I.type === 10 ? 2 : 4,
                  ...
                  R;
                (I.type === 10
                  ? ((R = A.length > 4 ? 16 : A.length > 2 ? 8 : A.length * z),
                    (M = A.length > 4 ? 16 : z * A.length))
                  : ((R = A.length <= 2 ? A.length * z : 16), (M = 16)),
                  (_ = Math.ceil(_ / R) * R),
                  w.push(_));
                let W = I.type === 10 ? 8 : 4;
                _ += A.length > 4 ? Math.ceil(A.length / W) * M : A.length * z;
              });
              let v = 16;
              _ = Math.ceil(_ / v) * v;
              ...
              let T = this.gpuDataManager.create(
                _,
                GPUBufferUsage.COPY_DST | GPUBufferUsage.UNIFORM,
              );
              (this.device.queue.writeBuffer(T.buffer, 0, $, 0, _),
                this.gpuDataManager.release(T.id),
                (m = { offset: 0, size: _, buffer: T.buffer }));
            }
            let h = this.programManager.normalizeDispatchGroupSize(d),
              b = h[1] === 1 && h[2] === 1,
              y = lp(t, n, b),
              g = this.programManager.getArtifact(y);
            if (
              (g ||
                ...
                j(
                  "info",
                  () => `[artifact] key: ${y}, programName: ${t.name}`,
                )),
              l && g.uniformVariablesInfo)
            ) {
              if (l.length !== g.uniformVariablesInfo.length)
                throw new Error(
                  `Uniform variables count mismatch: expect ${g.uniformVariablesInfo.length}, got ${l.length} in program "${g.programInfo.name}".`,
                );
              for (let _ = 0; _ < l.length; _++) {
                ...
                if (v !== T || $ !== I)
                  throw new Error(
                    `Uniform variable ${_} mismatch: expect type ${T} with size ${I}, got type ${v} with size ${$} in program "${g.programInfo.name}".`,
                  );
              }
            }
            if (
              ...
              let _ = {
                ...
                programName: g.programInfo.name,
                inputTensorViews: n,
                outputTensorViews: p,
              };
          ...
          computeKernel(t, n, r) {
            ...
            if (this.currentKernelId !== null)
              throw new Error(
                `kernel "[${i}] ${s}" is not allowed to be called recursively`,
              );
            ...
            try {
              return (
                d && this.device.pushErrorScope("validation"),
                a(n, u[1]),
                0
              );
            } catch (l) {
              return (
                r.push(
                  Promise.resolve(`[WebGPU] Kernel "[${i}] ${s}" failed. ${l}`),
                ),
                1
              );
            } finally {
              d &&
                r.push(
                  this.device
                    ...
                    .then((l) =>
                      l
                        ? `GPU validation error for kernel "[${i}] ${s}": ${l.message}`
                        : null,
                    ),
                );
          ...
          registerBuffer(t, n, r, o) {
            ...
            let s = i.get(n),
              a = this.gpuDataManager.registerExternalBuffer(r, o, s);
          ...
          createDownloader(t, n, r) {
            return async () => {
              let o = await Vn(this, t, n);
              return Gt(o.buffer, r);
            };
          }
          writeTimestamp(t) {
          ...
          replay() {
            ...
            for (let o = 0; o < r; o++) {
              ...
              (this.writeTimestamp(this.pendingDispatchNumber * 2),
                i.setPipeline(s.computePipeline),
                i.setBindGroup(0, s.bindGroup),
      ...
      ((bt = class e {
        ...
        (lr = class {
          ...
          compute(t, n) {
            let r =
                n?.inputs?.map((a) =>
                  typeof a == "number" ? this.inputs[a] : a,
                ) ?? this.inputs,
              o = n?.outputs ?? [],
              ...
              s = (a, u) => {
                ...
                return new bt(this.module, a, l, u);
              };
          ...
          output(t, n) {
            ...
            try {
              ...
              throw new Error(
                `Failed to generate kernel's output[${t}] with dims [${n}]. If you are running with pre-allocated output, please make sure the output type/dims are correct. Error: ${o}`,
              );
            } finally {
        ...
        (cp = async (e, t, n, r) => {
          ...
          if (e === "webgpu") {
                ...
                (a, u, d, l = !1) => {
                  if (l)
                    (j(
                      "verbose",
                      () =>
                        `[WebGPU] jsepCopyGpuToGpu: src=${Number(a)}, dst=${Number(u)}, size=${Number(d)}`,
                    ),
                    ...
                    j(
                      "verbose",
                      () =>
                        `[WebGPU] jsepCopyCpuToGpu: dataOffset=${Number(a)}, gpuDataId=${Number(u)}, size=${Number(d)}`,
                    );
                    let c = t.HEAPU8.subarray(
                      Number(a >>> 0),
                      Number(a >>> 0) + Number(d),
                    );
                    s.upload(Number(u), c);
                ...
                async (a, u, d) => {
                  (j(
                    ...
                    await s.download(Number(a), () =>
                      t.HEAPU8.subarray(Number(u) >>> 0, Number(u + d) >>> 0),
                    ));
                },
                (a, u, d) =>
                  s.createKernel(
                    ...
                    Number(u),
                    d,
                    t.UTF8ToString(t._JsepGetNodeName(Number(u))),
                  ),
                (a) => s.releaseKernel(a),
                (a, u, d, l) => {
                  j(
            ...
            o("webnn", [
              ...
              async (s, a, u, d, l) => i.ensureTensor(s, a, u, d, l),
              (s, a) => {
                i.uploadTensor(s, a);
              },
              async (s, a) => i.downloadTensor(s, a),
            ]);
          }
        }));
    });
  var pp,
    ...
    In = E(() => {
      ...
      ((pp = (e, t) => {
        ...
        (Ct = async (e) => {
          pp(e.wasm.numThreads, pt(e.logLevel));
        }),
        (At = async (e, t) => {
          ne().asyncInit?.();
          {
            ...
            if (t === "webgpu") {
              ...
              if (r) {
                ...
                if (i !== void 0 && typeof i != "boolean")
                  throw new Error(
                    `Invalid forceFallbackAdapter setting: "${i}"`,
                  );
                if (
        ...
        (kt = async (e, t) => {
          ...
          try {
            if (
              (([s, u] = await ro(t)), t?.externalData && o.mountExternalData)
            ) {
              let w = [];
              ...
              if ((typeof w == "string" ? w : w.name) === "webnn") {
                if (((o.shouldTransferToMLTensor = !1), typeof w != "string")) {
                  ...
                  T
                    ? (o.currentContext = T)
                    : I
                      ? (o.currentContext = await o.webnnCreateMLContext(I))
            ...
            ((i = await o._OrtCreateSession(n, r, s)),
              o.webgpuOnCreateSession?.(i),
              i === 0 && Y("Can't create a session."),
              o.jsepOnCreateSession?.(),
              o.currentContext &&
                (o.webnnRegisterMLContext(i, o.currentContext),
                (o.currentContext = void 0),
                (o.shouldTransferToMLTensor = !0)));
            let [c, p] = mp(i),
            ...
            for (let w = 0; w < c; w++) {
              ...
              (m.push(I),
                b.push(
                  $ === 0
                    ? { name: I, isTensor: !1 }
                    : { name: I, isTensor: !0, type: ke($), shape: T },
                ));
            }
            for (let w = 0; w < p; w++) {
              let [v, $, T] = Tu(i, w + c);
                ...
                ));
              {
                ...
                if (
                  ...
                  throw new Error(
                    `Not supported preferred output location: ${A}.`,
                  );
                if (f && A !== "gpu-buffer")
                  throw new Error(
              ...
              g.some(
                ...
                (_ = {
                  ...
                  outputPreferredLocationsEncoded: g
                    .map((w) =>
                      w === "ml-tensor-cpu-output" ? "ml-tensor" : w,
                    )
                    .map((w) => En(w)),
                })),
            ...
            throw (
              d.forEach((p) => o._OrtFree(p)),
              l.forEach((p) => o._OrtFree(p)),
              a !== 0 &&
                o._OrtReleaseBinding(a) !== 0 &&
                Y("Can't release IO binding."),
              i !== 0 &&
                o._OrtReleaseSession(i) !== 0 &&
                Y("Can't release session."),
              c
            );
          } finally {
            (o._free(n),
              s !== 0 &&
                o._OrtReleaseSessionOptions(s) !== 0 &&
                Y("Can't release session options."),
              u.forEach((c) => o._free(c)),
              o.unmountExternalData?.());
          }
        }),
        (Et = (e) => {
          let t = ne(),
          ...
          (s &&
            (a &&
              t._OrtClearBoundOutputs(s.handle) !== 0 &&
              Y("Can't clear bound outputs."),
            t._OrtReleaseBinding(s.handle) !== 0 &&
              Y("Can't release IO binding.")),
            t.jsepOnReleaseSession?.(e),
            t.webnnOnReleaseSession?.(e),
            t.webgpuOnReleaseSession?.(e),
            o.forEach((u) => t._OrtFree(u)),
            i.forEach((u) => t._OrtFree(u)),
            t._OrtReleaseSession(r) !== 0 && Y("Can't release session."),
            Ye.delete(e));
        }),
        (Iu = async (e, t, n, r, o, i, s = !1) => {
          if (!e) {
            t.push(0);
            return;
          }
            ...
            if (Array.isArray(y)) {
              ...
              if (d !== "string" && g && _) {
                ...
                if (g(r, w) || _(r, w)) {
                  ...
                  let I = await $(r, v, l);
                  (T(I, new Uint8Array(y.buffer, y.byteOffset, y.byteLength)),
                    (f = I));
                } else
                  ((m = y.byteLength),
                    (f = a._malloc(m)),
                    n.push(f),
                    a.HEAPU8.set(new Uint8Array(y.buffer, y.byteOffset, m), f));
              } else
                ((m = y.byteLength),
                  (f = a._malloc(m)),
                  n.push(f),
          ...
          try {
            l.forEach((g, _) =>
              a.setValue(b + _ * u, g, u === 4 ? "i32" : "i64"),
            );
        ...
        (Pt = async (e, t, n, r, o, i) => {
          ...
          try {
            [y, g] = to(i);
            for (let O = 0; O < h; O++)
              await Iu(n[O], _, v, e, l[t[O]], t[O], f);
            for (let O = 0; O < b; O++)
              await Iu(o[O], w, v, e, c[r[O]], h + r[O], f);
            for (let O = 0; O < h; O++)
              (s.setValue(T + O * a, _[O], "*"),
                s.setValue(I + O * a, l[t[O]], "*"));
            for (let O = 0; O < b; O++)
              (s.setValue(A + O * a, w[O], "*"),
                s.setValue(z + O * a, c[r[O]], "*"));
            if (p && !m) {
              let {
                handle: O,
                outputPreferredLocations: ee,
                outputPreferredLocationsEncoded: G,
              } = p;
              if (l.length !== h)
                throw new Error(
                  `input count from feeds (${h}) is expected to be always equal to model's input count (${l.length}).`,
                );
              for (let D = 0; D < h; D++) {
                let Z = t[D];
                (await s._OrtBindInput(O, l[Z], _[D])) !== 0 &&
                  Y(`Can't bind input[${D}] for session=${e}.`);
              }
              for (let D = 0; D < b; D++) {
                let Z = r[D];
                o[D]?.[3]
                  ? s._OrtBindOutput(O, c[Z], w[D], 0) !== 0 &&
                    Y(`Can't bind pre-allocated output[${D}] for session=${e}.`)
                  : s._OrtBindOutput(O, c[Z], 0, G[Z]) !== 0 &&
                    Y(`Can't bind output[${D}] to ${ee[D]} for session=${e}.`);
              }
              Ye.set(e, [d, l, c, p, f, !0]);
            }
            ...
            for (let O = 0; O < b; O++) {
              ...
              try {
                ...
                for (let ue = 0; ue < L; ue++)
                  oe.push(Number(s.getValue(k + ue * a, se)));
                s._OrtFree(k) !== 0 && Y("Can't free memory for tensor dims.");
                ...
                if (U === "string") {
                  ...
                  ((Z = !0),
                    R.push([
                      ...
                      {
                        gpuBuffer: ae,
                        download: s.jsepCreateDownloader(ae, Ve, U),
                        dispose: () => {
                          s._OrtReleaseTensor(ee) !== 0 &&
                            Y("Can't release tensor.");
                        },
                      },
                      "gpu-buffer",
                    ]));
                  ...
                  ((Z = !0),
                    R.push([
                      ...
                      {
                        mlTensor: wt,
                        download: s.webnnCreateMLTensorDownloader(Q, U),
                        dispose: () => {
                ...
                (s.stackRestore(G),
                  U === "string" && Q && s._free(Q),
                  Z || s._OrtReleaseTensor(ee));
              }
            }
            p &&
              !f &&
              (s._OrtClearBoundOutputs(p.handle) !== 0 &&
                Y("Can't clear bound outputs."),
              Ye.set(e, [d, l, c, p, f, !1]));
            for (let [O, ee] of await Promise.all(W)) R[O][2] = ee;
            return R;
          } finally {
            (s.webnnOnRunEnd?.(d),
              s.stackRestore($),
              _.forEach((M) => s._OrtReleaseTensor(M)),
              w.forEach((M) => s._OrtReleaseTensor(M)),
              v.forEach((M) => s._free(M)),
              y !== 0 && s._OrtReleaseRunOptions(y),
              g.forEach((M) => s._free(M)));
          }
        }),
        (zt = (e) => {
          let t = ne(),
  ...
  var Je,
    ...
    mr = E(() => {
      ...
      ((Je = () => !!te.wasm.proxy && typeof document < "u"),
        ...
        (Cu = async () => {
          if (!fn) {
            if (_t) throw new Error("multiple calls to 'initWasm()' detected.");
            if (hn) throw new Error("previous call to 'initWasm()' failed.");
            if (((_t = !0), Je()))
            ...
            try {
              (await It(te.wasm), await Ct(te), (fn = !0));
            } catch (e) {
              throw ((hn = !0), e);
            } finally {
              _t = !1;
      ...
      ((Du = (e, t) => {
        ...
        (gn = class {
          async fetchModelAndCopyToWasmMemory(t) {
            return ku(await mt(t));
          }
          async loadModel(t, n) {
            fe();
            let r;
            (typeof t == "string"
              ? (r = await this.fetchModelAndCopyToWasmMemory(t))
              : (r = t),
              ([
                this.sessionId,
                this.inputNames,
          ...
          async run(t, n, r) {
            ...
            Object.entries(n).forEach((p) => {
              let f = p[0],
                m = p[1],
                h = this.outputNames.indexOf(f);
              if (h === -1) throw new Error(`invalid output '${f}'`);
              (s.push(m), a.push(h));
            });
            let u = o.map((p, f) =>
                Du(p, () => `input "${this.inputNames[i[f]]}"`),
              ),
              d = s.map((p, f) =>
                p ? Du(p, () => `output "${this.outputNames[a[f]]}"`) : null,
              ),
              l = await zu(this.sessionId, i, u, a, d, r),
              c = {};
            for (let p = 0; p < l.length; p++)
              c[this.outputNames[a[p]]] = s[p] ?? gp(l[p]);
            return (me(), c);
          }
          startProfiling() {}
          endProfiling() {
