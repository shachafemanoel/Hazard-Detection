...
var ort = (() => {
    ...
    "common/dist/esm/backend-impl.js"() {
      ...
      resolveBackendAndExecutionProviders = async (options) => {
        ...
        for (const backendName of backendNames) {
          const resolveResult =
            await tryResolveAndInitializeBackend(backendName);
    ...
    "common/dist/esm/env-impl.js"() {
      ...
      env = {
        ...
        set logLevel(value) {
          ...
          if (
            typeof value !== "string" ||
            ["verbose", "info", "warning", "error", "fatal"].indexOf(value) ===
              -1
          ) {
    ...
    "common/dist/esm/tensor-conversion-impl.js"() {
      ...
      tensorToDataURL = (tensor, options) => {
        ...
        if (pixels2DContext != null) {
          ...
          const inputformat =
            options?.format !== void 0 ? options.format : "RGB";
      ...
      InferenceSession = class _InferenceSession {
        ...
        static async create(arg0, arg1, arg2, arg3) {
          ...
          if (typeof arg0 === "string") {
            ...
            if (typeof arg1 === "object" && arg1 !== null) {
              ...
              if (typeof arg2 === "number") {
                ...
                if (
                  ...
                  throw new RangeError(
                    `'byteLength' is out of range (0, ${buffer.byteLength - byteOffset}].`,
                  );
                }
            ...
            filePathOrUint8Array = new Uint8Array(
              buffer,
              byteOffset,
              byteLength,
            );
      ...
      importWasmModule = async (
        ...
        if (
          ...
          const url = needPreload
            ...
            : (wasmModuleUrl ??
              fallbackUrl(wasmModuleFilename, prefixOverride));
  ...
  var init_wasm_factory = __esm({
    "web/lib/wasm/wasm-factory.ts"() {
      ...
      initializeWebAssembly = async (flags) => {
        ...
        const mjsPathOverride =
          mjsPathOverrideFlag?.href ?? mjsPathOverrideFlag;
    ...
    "web/lib/wasm/wasm-utils.ts"() {
      ...
      checkLastError = (message) => {
        ...
        try {
          ...
          const errorMessagePointer = wasm2.getValue(
            paramsOffset + ptrSize,
            "*",
          );
      ...
      setRunOptions = (options) => {
        ...
        try {
          if (options?.logSeverityLevel === void 0) {
            ...
            throw new Error(
              `log serverity level is not valid: ${options.logSeverityLevel}`,
            );
          }
    ...
    "web/lib/wasm/session-options.ts"() {
      ...
      appendSessionConfig = (sessionOptionsHandle, key, value, allocs) => {
        ...
        if (
          ...
          checkLastError(
            `Can't set a session config entry: ${key} - ${value}.`,
          );
        }
      };
    ...
    "web/lib/wasm/wasm-core-impl.ts"() {
      ...
      createSession = async (modelData, options) => {
        ...
        if (Array.isArray(modelData)) {
          ...
          [modelDataOffset, modelDataLength] =
            copyFromExternalBuffer(modelData);
        }
        let sessionHandle = 0;
        let sessionOptionsHandle = 0;
            ...
            if (providerName === "webnn") {
              ...
              if (typeof provider !== "string") {
                ...
                if (context) {
                  ...
                  wasm2.currentContext =
                    await wasm2.webnnCreateMLContext(gpuDevice);
                } else {
          ...
          if (Array.isArray(data)) {
            ...
            for (let i = 0; i < data.length; i++) {
              if (typeof data[i] !== "string") {
                throw new TypeError(
                  `tensor data at index ${i} is not a string`,
                );
              }
              wasm2.setValue(
                rawData + i * ptrSize,
            ...
            try {
              ...
              if (type === "string") {
                ...
                if (preferredLocation === "gpu-buffer" && size > 0) {
                  ...
                  if (
                    !isGraphInputOutputTypeSupported(sessionId, type, false)
                  ) {
                    throw new Error(
              ...
              try {
                ...
                if (false) {
                  message.in.wasm.wasmPaths = {
                    wasm: false
                      ? new URL("ort-wasm-simd-threaded.jsep.wasm", void 0).href
                      : new URL("ort-wasm-simd-threaded.wasm", void 0).href,
                  };
                }
  ...
  if (true) {
    const wasmBackend2 = (init_backend_wasm(),
    __toCommonJS(backend_wasm_exports)).wasmBackend;
    if (false) {
